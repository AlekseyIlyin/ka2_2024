...
Процедура СформироватьДоходыНДФЛ(Начисления, ДоговорыПодряда)
	...
	Если НастройкиУчета.ИспользоватьСтатьиФинансирования
		И НаборыЗаписей.СведенияОДоходахНДФЛ.ДополнительныеСвойства.Свойство("КорректировкиПоУчетам") Тогда
		ДополнитьСведенияОДоходахНДФЛСведениямиОРаспределенииПоСтатьям(НаборыЗаписей);
	КонецЕсли;
...
Процедура ДополнитьСведенияОДоходахНДФЛСведениямиОРаспределенииПоСтатьям(НаборыЗаписей)
