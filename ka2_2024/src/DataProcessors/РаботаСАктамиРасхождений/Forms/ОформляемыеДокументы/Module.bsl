...
Процедура ВывестиДокументДопоставкиПоПоступлениюНаСклад(СтрокаДействия, Макет, Описание)
	...
	ПараметрыПоискаСкладов = Новый Структура("ВариантДействия", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеПриемки.ОжидатьДопоставкуБезОформления);
	...
	Для Каждого СкладПоступления Из МассивСкладовПоступления Цикл
		...
		ОформленныеДокументы = ПоступленияПоступленияНаСклад.НайтиСтроки(Новый Структура("Основание, Склад",
