...
Функция НастройкиФормыИзмененияРеквизитовДляТоваров(Заголовок, Уведомление)
	...
	СтруктураИзменяемогоРеквизита.Вставить("СписокКодовУсловийПометки", КонтролируемыеСделкиПовтИсп.ПереченьКодовТНВЭДМировойБиржевойТорговли(Уведомление.ОтчетныйГод));
