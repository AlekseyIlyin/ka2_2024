...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СвойстваУстановлены = Параметры.Свойство("ПараметрыОтображенияОстатковЦен", ПараметрыОтображенияОстатковЦен)
		И Параметры.Свойство("УчетнаяЗапись", УчетнаяЗапись);
...
Процедура ИнициализироватьДеревоНастроек()
	...
	ИспользуемыеСклады = ИнтеграцияСМаркетплейсомOzonСервер.ПолучитьСопоставленныеСклады(УчетнаяЗапись, Истина, Ложь);
