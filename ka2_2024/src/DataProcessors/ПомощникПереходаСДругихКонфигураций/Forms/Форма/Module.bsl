		...
		Иначе
			...
			Если ТекущийЭтап = "Загрузка" Тогда
				...
				ИначеЕсли Объект.КонфигурацияИсточник = "ЗУП31" Тогда
					Если ЗначениеЗаполнено(Объект.СтатьяДоходов) Или ЗначениеЗаполнено(Объект.СтатьяРасходов) Тогда
...
Процедура ЗаполнитьДанныеВДокументахРезервыОтпусков()
	...
	Пока Выборка.Следующий() Цикл
		...
		ЗаполнятьСтатьюРасходов = Ложь;
		ЗаполнятьАналитикуДоходов = Ложь; 
		ЗаполнятьАналитикуРасходов = Ложь;
		...
		КонецЕсли; 
		Если ЗначениеЗаполнено(Объект.СтатьяРасходов) И Выборка.СтатьяРасходов <> Объект.СтатьяРасходов Тогда
			ЗаполнятьСтатьюРасходов = Истина;
		КонецЕсли;
		...
		КонецЕсли; 
		Если ЗначениеЗаполнено(Объект.АналитикаРасходов) И Выборка.АналитикаРасходов <> Объект.АналитикаРасходов Тогда 
			ЗаполнятьАналитикуРасходов = Истина;
		КонецЕсли; 
		Если НЕ (ЗаполнятьСтатьюДоходов Или ЗаполнятьСтатьюРасходов Или ЗаполнятьАналитикуДоходов Или ЗаполнятьАналитикуРасходов) Тогда
			Продолжить;
		КонецЕсли;
		...
		КонецЕсли;
		Если ЗаполнятьСтатьюРасходов Тогда
			ДокОбъект.СтатьяРасходов = Объект.СтатьяРасходов;
		КонецЕсли;
		...
		Если ЗаполнятьАналитикуРасходов Тогда
			ДокОбъект.АналитикаРасходов = Объект.АналитикаРасходов;
		КонецЕсли; 
