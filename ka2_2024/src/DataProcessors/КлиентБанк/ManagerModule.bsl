...
Процедура ЗаполнитьРасшифровкуПлатежаПоОбъектуРасчетов(ДанныеРасшифровки)
	...
	СвойстваОбъектаРасчета = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДанныеРасшифровки.ОбъектРасчетов, РеквизитыОбъектаРасчетов);
	ЗаполнитьЗначенияСвойств(ДанныеРасшифровки, СвойстваОбъектаРасчета);
