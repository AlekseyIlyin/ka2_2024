...
Функция СкопироватьНастройки()
	...
	//++ НЕ УТ
	НастройкиДляКопирования.Добавить("НастройкиУчетаНалогаНаПрибыль",	НСтр("ru = 'Настройки учета налога на прибыль'"), СкопироватьНастройкиУчетаНалогаНаПрибыль);
	НастройкиДляКопирования.Добавить("НастройкиУчетаУСН",				НСтр("ru = 'Настройки учета УСН'"), СкопироватьНастройкиУчетаУСН);
	НастройкиДляКопирования.Добавить("УчетнаяПолитикаБухУчета",			НСтр("ru = 'Учетная политика бухгалтерского учета'"), СкопироватьУчетнаяПолитикаБухУчета);
	НастройкиДляКопирования.Добавить("СтавкиНалогаНаИмущество",			НСтр("ru = 'Ставки налога на имущество'"), СкопироватьСтавкиНалогаНаИмущество);
	//-- НЕ УТ
