...
Функция ТипОшибкиПоИмениЭтапа(ИмяРаздела = "Себестоимость", КодОсновногоЯзыка)
	...
	//++ НЕ УТ
	СоответствиеТипаОшибкиИмениЭтапа.Вставить("УСН", НСтр("ru = 'Расхождения при расчете отражения доходов и расходов при УСН'", КодОсновногоЯзыка));
	СоответствиеТипаОшибкиИмениЭтапа.Вставить("РеглУчет", НСтр("ru = 'Расхождения при отражении документов в регл. учете'", КодОсновногоЯзыка));
	//-- НЕ УТ
	//-- Локализация
	...
	//++ НЕ УТ
	МассивСтрок = Новый Массив;
	МассивСтрок.Добавить(НСтр("ru = 'Формирование КУДиР.'", КодОсновногоЯзыка));
	МассивСтрок.Добавить(НСтр("ru = 'Признание расходов.'", КодОсновногоЯзыка));
	СоответствиеТипаОшибкиИмениЭтапа.Вставить(СтрСоединить(МассивСтрок),
		НСтр("ru = 'Ошибка при расчете отражения доходов и расходов при УСН'", КодОсновногоЯзыка));
	
	СоответствиеТипаОшибкиИмениЭтапа.Вставить(НСтр("ru = 'Отражение в регламентированном учете'", КодОсновногоЯзыка),
		НСтр("ru = 'Ошибка при отражении документов в регл. учете'", КодОсновногоЯзыка));
	//-- НЕ УТ
	//-- Локализация
