...
Функция ОбъединитьИОчиститьЗадвоенныеДанныеФизическихЛиц(РезультатОбъединения, МассивФизическихЛиц, ВладелецОставляемыхФИО, АдресВоВременномХранилище = Неопределено) Экспорт
	...
	Если ЗначениеЗаполнено(ВладелецОставляемыхФИО) И ВладелецОставляемыхФИО <> ОставляемоеФизическоеЛицо Тогда
