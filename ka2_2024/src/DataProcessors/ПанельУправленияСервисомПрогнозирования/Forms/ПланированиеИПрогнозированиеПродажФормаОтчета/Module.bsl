...
Процедура УстановитьПараметрДетализацииПоУмолчанию()
	...
	ЗначенияДетализаций = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВидПлана, "ЗаполнятьСклад, ЗаполнятьСкладВТЧ,
	...
	Если ТипПлана = Перечисления.ТипыПланов.ПланПродаж Тогда
		...
		Если ЗначенияДетализаций.ЗаполнятьПоХарактеристикамНоменклатуры
			И (ЗначенияДетализаций.ЗаполнятьСклад Или ЗначенияДетализаций.ЗаполнятьСкладВТЧ)
			И (ЗначенияДетализаций.ЗаполнятьПартнера Или ЗначенияДетализаций.ЗаполнятьПартнераВТЧ) Тогда
		...
		ИначеЕсли ЗначенияДетализаций.ЗаполнятьПоХарактеристикамНоменклатуры
			И (ЗначенияДетализаций.ЗаполнятьСклад Или ЗначенияДетализаций.ЗаполнятьСкладВТЧ) Тогда
			
			ДетализацияПоУмолчанию  = "ПоСкладамХарактеристикам";
			ИспользоватьДетализацию = Истина;
			
		ИначеЕсли (ЗначенияДетализаций.ЗаполнятьСклад Или ЗначенияДетализаций.ЗаполнятьСкладВТЧ)
			И (ЗначенияДетализаций.ЗаполнятьПартнера Или ЗначенияДетализаций.ЗаполнятьПартнераВТЧ) Тогда
		...
		ИначеЕсли ЗначенияДетализаций.ЗаполнятьПартнера Или ЗначенияДетализаций.ЗаполнятьПартнераВТЧ Тогда
			
			ДетализацияПоУмолчанию  = "ПоКлиентам";
			ИспользоватьДетализацию = Истина;
			
		ИначеЕсли ЗначенияДетализаций.ЗаполнятьСклад Или ЗначенияДетализаций.ЗаполнятьСкладВТЧ Тогда
			ИспользоватьДетализацию = Истина;
		КонецЕсли;
		
	Иначе
		
		Если ЗначенияДетализаций.ЗаполнятьСклад Или ЗначенияДетализаций.ЗаполнятьСкладВТЧ Тогда
			ИспользоватьДетализацию = Истина;
		КонецЕсли;
...
Процедура ОбновитьПрогнозНаСервере()
	...
	Если ЗначениеЗаполнено(ВидПлана) Тогда
		...
		НастройкиСервиса = СервисПрогнозирования.ПолучитьНастройкиСервиса();
		ТребуемыеРеквизиты = "НачалоПрогнозирования, ЗаполнятьПартнера, ЗаполнятьПартнераВТЧ, ЗаполнятьПоХарактеристикамНоменклатуры";
