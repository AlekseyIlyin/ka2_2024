...
&НаКлиенте
Процедура ИспользоватьПроизводительныйРежимЗаписиИнформацииОДоступностиТоваровИРаботПриИзменении(Элемент)
	Подключаемый_ПриИзмененииРеквизита(Элемент);
	ОбеспечениеВДокументахКлиент.ПриИзмененииПроизводительногоРежима(УникальныйИдентификатор);
КонецПроцедуры
