...
Процедура УстановитьВидимостьДоступность()
	...
	Если ИспользуетсяОграничениеПоСкладу Тогда
		Элементы.СписокДокументыПроизводстваСклад.Видимость = Истина;
	Иначе
		Элементы.СписокДокументыПроизводстваСклад.Видимость = Ложь;
	КонецЕсли;
...
Процедура УстановитьОтборыДинамическихСписков()
	...
	Если ИспользуетсяОграничениеПоПодразделению Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
		СписокДокументыПроизводства,
		"УбратьДубль",
		Ложь,
