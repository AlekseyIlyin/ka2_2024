...
Процедура ОбновитьДанныеИнформационнойПанели(ОтобразитьСдачу = Ложь)
	...
	ИнформационнаяПанельСуммаКВозврату                  = ИнформацияОбОплате.СуммаДокумента;
	ИнформационнаяПанельСуммаКВозвратуНаличными         = ИнформацияОбОплате.СуммаКОплате;
	ИнформационнаяПанельСуммаКВозвратуПлатежнымиКартами = 0;
	Если ИнформацияОбОплате.ПлатежныеКарты > 0 Тогда
		ИнформационнаяПанельСуммаКВозвратуПлатежнымиКартами = Мин(ИнформационнаяПанельСуммаКВозвратуНаличными, ИнформацияОбОплате.ПлатежныеКарты);
		ИнформационнаяПанельСуммаКВозвратуНаличными         = ИнформационнаяПанельСуммаКВозвратуНаличными - ИнформационнаяПанельСуммаКВозвратуПлатежнымиКартами;
	КонецЕсли;
	ИнформационнаяПанельЛокализация(ЭтотОбъект, ИнформацияОбОплате);
...
Функция ИнформацияОбОплате()
	...
	ИнформацияОбОплате.Вставить("ПлатежныеКарты",         ОбщаяСуммаОплатыПлатежнымиКартами);
	...
	ИнформацияОбОплатеЛокализация(ЭтотОбъект, ИнформацияОбОплате);
...
Процедура ИнформационнаяПанельЛокализация(Форма, ИнформацияОбОплате)
	...
	Если ИнформацияОбОплате.СБП > 0 Тогда
		Форма.ИнформационнаяПанельСуммаКВозвратуСБП = Мин(ИнформацияОбОплате.СБП, Форма.ИнформационнаяПанельСуммаКВозврату);
		Если ИнформацияОбОплате.ПлатежныеКарты > 0 Тогда
			Форма.ИнформационнаяПанельСуммаКВозвратуПлатежнымиКартами = Мин(Форма.ИнформационнаяПанельСуммаКВозврату - Форма.ИнформационнаяПанельСуммаКВозвратуСБП, ИнформацияОбОплате.ПлатежныеКарты);
		КонецЕсли;
		
		Форма.ИнформационнаяПанельСуммаКВозвратуНаличными
			 = Форма.ИнформационнаяПанельСуммаКВозврату - Форма.ИнформационнаяПанельСуммаКВозвратуПлатежнымиКартами - Форма.ИнформационнаяПанельСуммаКВозвратуСБП;
	КонецЕсли;
	//-- Локализация
