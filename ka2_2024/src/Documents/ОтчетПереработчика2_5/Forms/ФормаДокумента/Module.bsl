...
Процедура ПередЗаписьюНаКлиентеСервер()
	...
	ВзаиморасчетыВызовСервера.ФормаПередЗаписьюНаСервере(ЭтотОбъект);
...
Процедура МатериалыИРаботыПриОкончанииРедактирования(Элемент, НоваяСтрока, ОтменаРедактирования)
	ТаблицаПриОкончанииРедактирования("МатериалыИРаботы", Элемент, НоваяСтрока, ОтменаРедактирования);
КонецПроцедуры
...
Процедура ОбновитьСостояниеСервер()
	...
	Документы.ОтчетПереработчика2_5.РассчитатьСостояние(
		Объект.Ссылка,
		Объект.Договор,
		ЭтотОбъект);
...
Функция ОтчетыПоДаннымПереработчика(ТекущийЗаказ, Контрагент, НомерВходящегоДокумента)
	...
	ДатаВходящегоДокумента =
		?(ЗначениеЗаполнено(ТекущийЗаказ.ДатаВходящегоДокумента),
			ТекущийЗаказ.ДатаВходящегоДокумента,
