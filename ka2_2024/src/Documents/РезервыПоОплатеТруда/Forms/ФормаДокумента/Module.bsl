...
Процедура ЗаполнитьСтатьиИАналитикуЗначениямиПоУмолчанию()
	...
	Если НЕ ЗначениеЗаполнено(Объект.СтатьяРасходов) И ЗначениеЗаполнено(ЗначенияЗаполнения.СтатьяРасходов)
		И Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийРезервовПоОплатеТруда.Инвентаризация") Тогда
		ЗаполнитьЗначенияСвойств(Объект, ЗначенияЗаполнения, "СтатьяРасходов, АналитикаРасходов");
