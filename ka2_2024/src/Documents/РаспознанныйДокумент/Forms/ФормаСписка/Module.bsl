...
Процедура ПроверитьЗаданияИЗагрузить(Команда)
	...
	ПодключитьОбработчикОжидания("Подключаемый_ОбновитьПредставлениеБаланса", 0.1, Истина);
	ПодключитьОбработчикОжидания("Подключаемый_ОбновитьКоличествоФайловПоСтатусам", 0.1, Истина);
...
&НаКлиенте
Процедура Подключаемый_ОбновитьКоличествоФайловПоСтатусам()
...
Процедура Подключаемый_ОбновитьПредставлениеБаланса()
	...
	ДлительнаяОперация = НачатьПолучениеСостояниеБаланса();
...
&НаСервере
Функция НачатьПолучениеСостояниеБаланса()
