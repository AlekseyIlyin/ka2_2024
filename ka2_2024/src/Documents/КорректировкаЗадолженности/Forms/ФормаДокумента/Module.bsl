...
Процедура ЗадолженностьТипРасчетовПриИзменении(Элемент)
	...
	Элементы.ДатаПлатежаБезРазбиентия.Видимость = ВидимостьДатыПлатежаБезРазбиения(
		Объект.ЭтоНачисление,
		Объект.ХозяйственнаяОперация,
		СтрокаТаблицы.ТипРасчетов);
КонецПроцедуры
...
Процедура УстановитьЗадолженностьБезРазбиения()
	...
	Элементы.ДатаПлатежаБезРазбиентия.Видимость = ВидимостьДатыПлатежаБезРазбиения(
		Объект.ЭтоНачисление,
		Объект.ХозяйственнаяОперация,
		Объект.Задолженность[0].ТипРасчетов);
...
Функция ВидимостьДатыПлатежаБезРазбиения(ЭтоНачисление, ХозяйственнаяОперация, ТипРасчетов)
	
	Возврат
		ЭтоНачисление
		И (ХозяйственнаяОперация = ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.НачислениеДебиторскойЗадолженности")
			И ТипРасчетов = ПредопределенноеЗначение("Перечисление.ТипыРасчетовСПартнерами.РасчетыСКлиентом")
			Или ХозяйственнаяОперация = ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.НачислениеКредиторскойЗадолженности")
			И ТипРасчетов = ПредопределенноеЗначение("Перечисление.ТипыРасчетовСПартнерами.РасчетыСПоставщиком")
			Или Не ЗначениеЗаполнено(ТипРасчетов));
