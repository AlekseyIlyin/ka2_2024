...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если Не Отказ И РежимЗаписи = РежимЗаписиДокумента.Проведение Тогда
		...
		Если НЕ ВнеоборотныеАктивы.СозданДляПереходаНаФСБУ25_2018(Дата, Организация) Тогда
...
Процедура ЗаполнитьНалогообложениеПередЗаписью() Экспорт
	...
	ИспользуетсяУчетАрендыПоФСБУ25_2018 = ВнеоборотныеАктивы.ИспользуетсяУчетАрендыПоФСБУ25_2018(Организация, Дата, Истина);
