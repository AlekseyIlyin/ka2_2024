...
Функция ТекстЗапросаВтТаблицаВидыЗапасов(Запрос, ТекстыЗапроса)
	...
	|	ПО АналитикаРасчетов.Партнер = ВидыЗапасов.Ссылка.Партнер
	|		И АналитикаРасчетов.Организация = ВидыЗапасов.Ссылка.Организация
	|		И АналитикаРасчетов.Контрагент = ВидыЗапасов.Ссылка.Контрагент
...
Функция ТекстЗапросаВтРаботыУслуги(Запрос, ТекстыЗапроса)
	...
	|
	|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АналитикаУчетаПоПартнерам КАК АналитикаРасчетов
	|	ПО АналитикаРасчетов.Партнер = ТаблицаТовары.Ссылка.Партнер
	|		И АналитикаРасчетов.Организация = ТаблицаТовары.Ссылка.Организация
	|		И АналитикаРасчетов.Контрагент = ТаблицаТовары.Ссылка.Контрагент
...
Функция ОписаниеОперацийУчетаСебестоимости(Документ) Экспорт
	...
	|	И ТаблицаДокумента.Статус <> ЗНАЧЕНИЕ(Перечисление.СтатусыРеализацийТоваровУслуг.КПредоплате)
	|	И (ТаблицаДокумента.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыРеализацийТоваровУслуг.Отгружено)
	|		ИЛИ НЕ ТаблицаДокумента.ХозяйственнаяОперация В (
	|			ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияЧерезКомиссионераБезПереходаПраваСобственности),
	|			ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияБезПереходаПраваСобственности)))
	|";
