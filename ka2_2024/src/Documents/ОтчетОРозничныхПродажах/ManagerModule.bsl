...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("6d02fa5a-4dde-3943-9ed3-54c57d837b25");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение в документе ""Отчет о розничных продажах"" нового реквизита ""Вид оплаты"" табличной части ""Оплата платежными картами"" значением ""Платежная карта""'");
