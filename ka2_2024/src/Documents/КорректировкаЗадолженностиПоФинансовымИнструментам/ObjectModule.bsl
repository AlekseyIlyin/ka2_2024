...
Процедура ОчиститьРасчетныйДокумент()
	...
	Для Каждого СтрокаТабличнойЧасти Из Задолженность Цикл
		...
		Если НЕ (ЗначениеЗаполнено(СтрокаТабличнойЧасти.РасчетныйДокумент)
			ИЛИ ТипЗнч(СтрокаТабличнойЧасти.РасчетныйДокумент) = Неопределено)
			ИЛИ СтрокаТабличнойЧасти.ТипСуммы <> Перечисления.ТипыПлатежейПоАренде.ОбеспечительныйПлатеж Тогда
