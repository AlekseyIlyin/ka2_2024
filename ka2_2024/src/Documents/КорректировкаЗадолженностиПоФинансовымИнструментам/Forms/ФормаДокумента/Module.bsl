...
Процедура НастройкаРасчетногоДокумента()
	...
	Если СтрокаТабличнойЧасти.ТипСуммы = ПредопределенноеЗначение("Перечисление.ТипыПлатежейПоАренде.ОбеспечительныйПлатеж") Тогда
		Элементы.ЗадолженностьРасчетныйДокумент.ТолькоПросмотр = Ложь;
	ИначеЕсли Объект.ХарактерДоговора = ПредопределенноеЗначение("Перечисление.ХарактерыДоговоровФинансовыхИнструментов.Аренда") Тогда
		Элементы.ЗадолженностьРасчетныйДокумент.ТолькоПросмотр = Ложь;
	Иначе
