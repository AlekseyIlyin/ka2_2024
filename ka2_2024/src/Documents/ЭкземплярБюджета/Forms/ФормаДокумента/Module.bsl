...
Процедура УдалитьСтроку(Команда)
	...
	УдаленоСтрок = 0;
	УдалитьСтрокуНаСервере(МассивСтрок, МассивРасшифровокПоСтрокам, ПараметрыВыводаВидаБюджета, УдаленоСтрок);
...
&НаСервере
Процедура УдалитьСтрокуНаСервере(МассивСтрок, МассивРасшифровокПоСтрокам, АдресПараметровВидаБюджета, УдаленоСтрок)
