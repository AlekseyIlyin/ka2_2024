...
Процедура УстановитьВидимость()
	...
	//++ Локализация
	Элементы.ЗадолженностьКлиентовОтложенныйДоходНУ.Видимость = Объект.ОтражатьВБУиНУ;
	Элементы.ЗадолженностьПоставщикамОтложенныйДоходНУ.Видимость = Объект.ОтражатьВБУиНУ;
	Элементы.ЗадолженностьКлиентовОтложенныйРасходНУ.Видимость = Ложь;
	Элементы.ЗадолженностьПоставщикамОтложенныйРасходНУ.Видимость = Ложь;
	ДатаДокумента = ?(ЗначениеЗаполнено(Объект.Дата), Объект.Дата, ТекущаяДатаСеанса());
	Если ДатаДокумента >= РегистрыСведений.НастройкиУчетаНалогаНаПрибыль.НачалоПрименения67ФЗПоРасходам() Тогда
		Элементы.ЗадолженностьКлиентовОтложенныйРасходНУ.Видимость = Объект.ОтражатьВБУиНУ;
		Элементы.ЗадолженностьПоставщикамОтложенныйРасходНУ.Видимость = Объект.ОтражатьВБУиНУ;
	КонецЕсли;
	//-- Локализация
