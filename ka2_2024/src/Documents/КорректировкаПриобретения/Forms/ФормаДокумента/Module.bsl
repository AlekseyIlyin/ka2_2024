...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВариантОформленияДоговораЗакупок = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.Договор, "ВариантОформленияЗакупок");
...
Процедура РасхожденияПриАктивизацииЯчейки(Элемент)
	...
	Если Элемент.ТекущийЭлемент <> Неопределено
		...
		ТипыНоменклатурыКорректировки.Добавить(ПредопределенноеЗначение("Перечисление.ТипыНоменклатуры.Услуга"));
		ТипыНоменклатурыКорректировки.Добавить(ПредопределенноеЗначение("Перечисление.ТипыНоменклатуры.Работа"));
