...
Процедура СоздатьСписание()
	...
	Для Каждого ИдентификаторСтроки Из Элементы.Список.ВыделенныеСтроки Цикл
		...
		СвойстваТМЦ = Новый Структура("ИнвентарныйНомер,Номенклатура,Характеристика,Серия,ФизическоеЛицо,НаправлениеДеятельности,Партия,Количество");
...
Процедура СоздатьВозврат()
	...
	Для Каждого ИдентификаторСтроки Из Элементы.Список.ВыделенныеСтроки Цикл
		...
		СвойстваТМЦ = Новый Структура("ИнвентарныйНомер,Номенклатура,Характеристика,Серия,ФизическоеЛицо,НаправлениеДеятельности,Партия,Количество,КоличествоУпаковок");
		ЗаполнитьЗначенияСвойств(СвойстваТМЦ, ДанныеСтроки);
