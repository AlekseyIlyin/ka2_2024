...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("6d0a2fa5-4dde-3394-9d3e-54837b21c57d");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение в документе ""Чек ККМ коррекция"" нового реквизита ""Вид оплаты"" табличной части ""Оплата платежными картами"" значением ""Платежная карта""'");
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|ИЗ
	|	Документ.ЧекККМКоррекции.ОплатаПлатежнымиКартами КАК ОплатаПлатежнымиКартами
	|ГДЕ
