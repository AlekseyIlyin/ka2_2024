...
Процедура ЗагрузитьИзФайла(Команда)
	...
	Если Объект[Команда.ИспользуемаяТаблица.Имя].Количество() > 0 Тогда
		...
		Оповещение = Новый ОписаниеОповещения("ЗагрузитьИзФайлаЗавершение", ЭтотОбъект, Команда.ИспользуемаяТаблица);
...
// Процедура выполняет пересчет суммы налогов
// 
// Параметры:
//  ТаблицаНалогов - ТаблицаЗначений - Таблица налогов
//  ВидыНалогов - Соответствие - Виды налогов
//  ВыделенныеСтроки - Массив из Число, Неопределено - Выделенные строки
//
&НаСервере
