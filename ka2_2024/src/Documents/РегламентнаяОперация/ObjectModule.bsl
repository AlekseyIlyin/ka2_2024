...
#Область РасчетыПоДисконтированию
	...
	|	&КонТекПериода       КАК ДатаОтражения,
	...
	|ГДЕ
	|	УчетнаяПолитикаФинУчета.Организация = &ГоловнаяОрганизация
	|	И УчетнаяПолитикаФинУчета.Период <= &КонТекПериода 
	|	
	|ИНДЕКСИРОВАТЬ ПО
	|	ГоловнаяОрганизация
	|;
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ПериодыНастройкиУчетнаяПолитикаФинУчета.Организация   КАК Организация,
	|	ПериодыНастройкиУчетнаяПолитикаФинУчета.ДатаОтражения КАК ДатаОтражения,
	...
	|		ПО ОбъектыРасчетов.Организация = УчетнаяПолитикаОрганизаций.Организация
	...
	|	РАЗНОСТЬДАТ(НАЧАЛОПЕРИОДА(Расчеты.ДатаВозникновения, ДЕНЬ), Расчеты.ДатаПлановогоПогашения, МЕСЯЦ) >=
	|		ЕСТЬNULL(УчетнаяПолитикаОрганизаций.МесяцыДолгосрочнойЗадолженности, 999)";
