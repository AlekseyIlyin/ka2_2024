...
&НаКлиенте
Процедура ПринятьКУчетуУзлыКомпоненты(Команда)
...
&НаКлиенте
Процедура Модернизировать(Команда)
