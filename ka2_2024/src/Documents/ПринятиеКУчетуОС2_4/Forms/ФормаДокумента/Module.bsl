...
Процедура ОрганизацияПриИзмененииНаСервере()
	...
	НастроитьЗависимыеЭлементыФормыНаСервере("Организация,ЕстьСвязанныеОрганизации");
...
Процедура ПорядокУчетаБУПриИзмененииНаСервере()
	...
	Если ЗначениеЗаполнено(Объект.СтатьяРасходовБУ) Тогда
		...
		ВариантыРаспределенияРасходов = ВнеоборотныеАктивыКлиентСервер.ДоступныеВариантыРаспределенияРасходов(Новый Структура("ПорядокУчетаБУ", Объект.ПорядокУчетаБУ));
...
Процедура ПорядокУчетаУУПриИзмененииНаСервере()
	...
	Если ЗначениеЗаполнено(Объект.СтатьяРасходовУУ) Тогда
		...
		ВариантыРаспределенияРасходов = ВнеоборотныеАктивыКлиентСервер.ДоступныеВариантыРаспределенияРасходов(Новый Структура("ПорядокУчетаУУ", Объект.ПорядокУчетаУУ));
		Если ВариантыРаспределенияРасходов.Количество() <> 0 Тогда
