...
Функция ТекстЗапросаЗаполненияСтатусовУказанияСерий(ПараметрыУказанияСерий) Экспорт
	...
	ИначеЕсли ПараметрыУказанияСерий.ИмяПоляСклад = "Договор" Тогда
		Возврат ТекстЗапросаЗаполненияСтатусовУказанияСерийПередачаВПереработку();
		//-- НЕ УТ
	Иначе
...
Функция ТекстЗапросаТаблицаСебестоимостьТоваров(Запрос, ТекстыЗапроса, Регистры) Экспорт
	...
	|			ВЫБОР
	|				КОГДА &ХозяйственнаяОперация В(ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковМатериаловПереданныхВПроизводство), ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковСобственныхТоваров))
...
Функция ТекстЗапросаЗаполненияСтатусовУказанияСерийПередачаВПереработку()
...
Функция ОстаткиПоТоварам(ДатаОстатков, ХозяйственнаяОперация, МассивОрганизаций, ДопОтбор, ПараметрыЗаполненияОстатков)
	...
	Если ЗаполнятьПоСебестоимости Тогда
		...
		|		ИНАЧЕ ОстаткиТоваров.СтоимостьОстаток / ОстаткиТоваров.КоличествоОстаток
		|	КОНЕЦ                                                 КАК Цена,
		|	ВЫБОР
		|		КОГДА ИСТИНА
		|			ТОГДА ОстаткиТоваров.СтоимостьОстаток + ОстаткиТоваров.ДопРасходыОстаток
		|	КОНЕЦ                                                 КАК Сумма,
		|	ВЫБОР
		|		КОГДА ИСТИНА
		|			ТОГДА ОстаткиТоваров.СтоимостьБезНДСОстаток + ОстаткиТоваров.ДопРасходыБезНДСОстаток
		...
		|		КОГДА ИСТИНА
		|			ТОГДА ОстаткиТоваров.СтоимостьОстаток + ОстаткиТоваров.ДопРасходыОстаток
		|				- (ОстаткиТоваров.СтоимостьБезНДСОстаток + ОстаткиТоваров.ДопРасходыБезНДСОстаток)
		|	КОНЕЦ                                                 КАК СуммаНДС,
		|	ВЫБОР
		|		КОГДА ОстаткиТоваров.СтоимостьБезНДСОстаток
		|				+ ОстаткиТоваров.ДопРасходыБезНДСОстаток = ОстаткиТоваров.СтоимостьРеглОстаток
		|			ТОГДА ОстаткиТоваров.СтоимостьОстаток + ОстаткиТоваров.ДопРасходыОстаток
		|				- (ОстаткиТоваров.СтоимостьБезНДСОстаток + ОстаткиТоваров.ДопРасходыБезНДСОстаток)
		|		ИНАЧЕ 0
		|	КОНЕЦ                                                 КАК НДСРегл,
