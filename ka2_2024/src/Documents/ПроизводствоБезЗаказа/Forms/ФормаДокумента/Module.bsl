...
Процедура УстановитьВидимостьЭлементов()
	...
	Элементы.ВыходныеИзделияЗаполнитьЦеныПоВидуЦен.Видимость = ИспользоватьПлановуюСтоимость;
...
Процедура ВыходныеИзделияДополнитьПоСпецификацииСервер(Знач Идентификаторы)
	...
	Для каждого СтруктураДанных Из ДанныеСпецификаций Цикл
		...
		Для Каждого Строка Из СтруктураДанных.ВыходныеИзделия Цикл
			...
			ДобавитьВСтруктуруДействияПриИзмененииНоменклатуры(
			"ВыходныеИзделия", НоваяСтрока, ЭтаФорма, СтруктураДействий, Истина, Ложь);
...
Функция ТаблицаОбъектаПоИмени(Объект, ИмяТаблицы)
	...
	ИначеЕсли ИмяТаблицы = "МатериалыИРаботы" Тогда
