...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "Документы.ОтчетОРозничныхВозвратах.ОбработатьДанныеДляПереходаНаНовуюВерсию";
	Обработчик.Версия = "11.5.10.14";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("6d02fa5a-4dde-3943-9ed3-54c57d837b26");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение в документе ""Отчет о розничных возвратах"" нового реквизита ""Вид оплаты"" табличной части ""Оплата платежными картами"" значением ""Платежная карта""'");
	...
	Блокируемые.Добавить(Метаданные.Документы.ОтчетОРозничныхВозвратах.ПолноеИмя());
