...
Функция ТекстЗапросаТаблицаВтИсходныеПрочиеРасходы(Запрос, ТекстыЗапроса)
	...
	ВнеоборотныеАктивыСлужебный.ТекстЗапросаТаблицаВтТаблицаОС(ТекстыЗапроса, "Документ.РеализацияУслугПрочихАктивов");
	//-- НЕ УТ
	...
	|	И ТаблицаДокумента.ВидАктива = ЗНАЧЕНИЕ(Перечисление.ВидыВнеоборотныхАктивов.НМА)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|		ПО Строки.ВнеоборотныйАктив = ТаблицаОС.ОсновноеСредство
	|
	|ГДЕ
	|	Строки.Ссылка = &Ссылка
	|	И Строки.ВосстановитьАмортизационнуюПремию
	|
	//-- НЕ УТ
	|";
...
Процедура ТекстЗапросаТаблицаВтТаблицаВНА(ТекстыЗапроса)
	...
	ВнеоборотныеАктивыСлужебный.ТекстЗапросаТаблицаВтПорядокУчетаОС(ТекстыЗапроса, "Документ.РеализацияУслугПрочихАктивов");
	ВнеоборотныеАктивыСлужебный.ТекстЗапросаТаблицаВтМестонахождениеОС(ТекстыЗапроса, "Документ.РеализацияУслугПрочихАктивов");
	ВнеоборотныеАктивыСлужебный.ТекстЗапросаТаблицаВтПорядокУчетаНМА(ТекстыЗапроса, "Документ.РеализацияУслугПрочихАктивов");
	ВнеоборотныеАктивыСлужебный.ТекстЗапросаТаблицаВтМестоУчетаНМА(ТекстыЗапроса, "Документ.РеализацияУслугПрочихАктивов");
