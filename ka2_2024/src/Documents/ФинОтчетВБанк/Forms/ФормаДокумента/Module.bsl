...
Процедура ПодписатьФинОтчет(ДополнительныеПараметры)
	...
	ДополнительныеПараметрыКриптографии = УниверсальныйОбменСБанкамиКлиент.НовыеДополнительныеПараметрыКриптографии();
	ДополнительныеПараметрыКриптографии.ПараметрыОтбора = ПараметрыОтбора;
	ДополнительныеПараметрыКриптографии.Заголовок = 
		СтрШаблон(НСтр("ru = 'Сертификат для %1'"), ПараметрыОтбора.ПредставлениеОтбора);
	ДополнительныеПараметрыКриптографии.ДобавитьМеткуДоверенногоВремени = 
		ПараметрыПодписания.ДобавитьМеткуДоверенногоВремени;
