...
Процедура СуммаПриИзменении(Элемент)
	...
	ЗаймыСотрудникамКлиентСервер.ЗаполнитьРазмерПогашения(Объект.РазмерПогашения, Объект.Сумма, Срок, ВидПлатежей, Объект.ОграничениеПлатежа, Объект.ДатаИзменений, ИзмененияУсловий);
...
Процедура СрокПриИзменении(Элемент)
	...
	ЗаймыСотрудникамКлиентСервер.ЗаполнитьРазмерПогашения(Объект.РазмерПогашения, ОстатокЗадолженности, Срок, ВидПлатежей, Объект.ОграничениеПлатежа, Объект.ДатаИзменений, ИзмененияУсловий);
	ЗаймыСотрудникамКлиентСервер.ЗаполнитьРазмерПлатежа(Объект.РазмерПлатежа, Срок, ВидПлатежей, ДанныеЗайма());
...
Процедура ТраншиЗаймаСрокПриИзменении(Элемент)
	...
	ЗаймыСотрудникамКлиентСервер.ЗаполнитьРазмерПогашения(ТекущаяСтрока.РазмерПогашения, ТекущаяСтрока.Сумма, ТекущаяСтрока.Срок, ВидПлатежей, Объект.ОграничениеПлатежа, Объект.ДатаИзменений);
