...
Процедура ЗаполнитьСлужебныеРеквизитыТЧ()
	...
	ДанныеУчета = Документы.ИнвентаризацияТМЦВЭксплуатации.ДанныеУчета(Объект.Дата, Объект.Товары);
	ДокументыНаОсновании = ДокументыНаОсновании(Объект.Ссылка, Объект.Организация, Объект.Подразделение, Объект.ФизическоеЛицо);
...
Процедура ПриИзмененииДанныхВСтроке(ДанныеСтроки)
	...
	ДанныеУчетаСтроки = ДанныеУчетаСтроки(Объект.Дата, Объект.Организация, Объект.Подразделение, Объект.ФизическоеЛицо, ДанныеСтрокиСтруктурой);
...
&НаСервереБезКонтекста
Функция ДанныеУчетаСтроки(Знач Дата, Знач Организация, Знач Подразделение, Знач ФизическоеЛицо, Знач ДанныеСтрокиСтруктурой)

	ДанныеУчета = Документы.ИнвентаризацияТМЦВЭксплуатации.ДанныеУчета(
		Дата, ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(ДанныеСтрокиСтруктурой));
