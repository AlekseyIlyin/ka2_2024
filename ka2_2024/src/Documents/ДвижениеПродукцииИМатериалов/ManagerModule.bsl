...
Функция ПечатьПередачаМатериаловВПроизводство(МассивОбъектов, ОбъектыПечати)
	...
	Если ВыводитьДопКолонку Тогда
		ЗапросПоДокументам.Текст = СтрЗаменить(ЗапросПоДокументам.Текст, "&ДопКолонка,", "Номенклатура." + ДопКолонка +" КАК ДопКолонка,");
	Иначе
		ЗапросПоДокументам.Текст = СтрЗаменить(ЗапросПоДокументам.Текст, "&ДопКолонка,", "");
	КонецЕсли;
