...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет значение пустого реквизита шапки ""Заказ поставщику"" значением ""Неопределено"".
	|Заполняет значение пустого реквизита ""Заказ поставщику"" табличной части ""Товары"" значением ""Неопределено"".
	|Пересчитывает сумму документа по данным табличной части ""Товары"".'");
