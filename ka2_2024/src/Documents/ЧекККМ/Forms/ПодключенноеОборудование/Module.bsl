...
Процедура ПриОткрытии(Отказ)
	...
	Иначе
		...
		ПодключаемоеОборудованиеПараметры = ПодключаемоеОборудование.ПараметрыПодключенияПО; // Массив из см. Справочники.ПодключаемоеОборудование.ПолучитьДанныеУстройства
