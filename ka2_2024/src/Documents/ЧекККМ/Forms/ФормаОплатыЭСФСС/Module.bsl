...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьДоступностьИзмененияОплатыНаличными();
...
&НаСервере
Процедура УстановитьДоступностьИзмененияОплатыНаличными()
	Элементы.ПолеПолученоНаличными.Доступность = ПредварительноеОдобрениеПолучено И КОплате > ОплаченоЭСФСС;
КонецПроцедуры
