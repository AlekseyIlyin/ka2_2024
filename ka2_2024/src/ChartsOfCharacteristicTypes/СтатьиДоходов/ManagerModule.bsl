...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Элемент.УдалитьСчетУчета = ПланыСчетов.Хозрасчетный.ПрочиеДоходы;
	//-- Локализация
	...
	ОписаниеТипа = Новый ОписаниеТипов(МассивТипов);
	Элемент.ТипЗначения = ОписаниеТипа;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Реализация ОС'", КодыЯзыков); // @НСтр-2
