...
Функция ДанныеРасшифровкиРасчетаПроцентов(МассивОбъектов) Экспорт
	...
	|
	|ВЫБРАТЬ
	|	ИзменениеУсловийДоговораАренды.Договор
	|ИЗ
	...
	|
	|ВЫБРАТЬ
	|	ВводОстатковВзаиморасчетовПоАренде.Договор
	|ИЗ
	...
	|	Справочник.ДоговорыАренды КАК ДоговорыАренды
	|ГДЕ
	|	ДоговорыАренды.Ссылка В (&МассивОбъектов)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|	УсловияДоговоровАрендыСрезПоследних.АктуальныеУсловияДоговора.ДатаНачалаАренды КАК ДатаНачалаАренды
	|ПОМЕСТИТЬ ВтУсловия
	|ИЗ
	|	РегистрСведений.УсловияДоговоровАренды.СрезПоследних(, Договор В
	|		(ВЫБРАТЬ
	|			ДоговорыАренды.Договор
	|		ИЗ
	|			ВтДоговорыАренды КАК ДоговорыАренды)) КАК УсловияДоговоровАрендыСрезПоследних
	|
	|ИНДЕКСИРОВАТЬ ПО
