...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	Если ВариантыАнализаСписок.Количество() = 0 Тогда
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Не выбрано ни одного варианта анализа'"), , , , Отказ);
	КонецЕсли;
...
Процедура ВариантыАнализаСписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	Если ЭтоМобильныйКлиент Тогда
		...
		ФормаРедактированияСтроки = ОткрытьФорму("Справочник.ДашбордыМЦП.Форма.ФормаРедактированияСтроки",
