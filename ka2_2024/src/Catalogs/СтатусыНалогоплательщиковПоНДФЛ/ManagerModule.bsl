...
Процедура НачальноеЗаполнение() Экспорт
	...
	ОписатьСтатусДистанционныйРаботник(Истина);
...
Процедура ОписатьСтатусДистанционныйРаботник(Переписывать = Ложь) Экспорт
	
	Если Переписывать Или Не ЗначениеЗаполнено(ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Справочники.СтатусыНалогоплательщиковПоНДФЛ.ДистанционныйРаботник, "КодФНС_2015")) Тогда
		СтатусБеженца = Справочники.СтатусыНалогоплательщиковПоНДФЛ.ДистанционныйРаботник.ПолучитьОбъект();
		СтатусБеженца.КодФНС = "2";
		СтатусБеженца.КодФНС_2015 = "8";
		СтатусБеженца.РеквизитДопУпорядочивания = 9;
		СтатусБеженца.ОбменДанными.Загрузка = Истина;
		СтатусБеженца.Записать();
	КонецЕсли;
