...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)           
	...
	ПодробноHTML = "<!DOCTYPE HTML>
			...
			|</tbody>
			|</table>", "")
				+ ?(ЕстьПроблемыПроактив Или ЕстьПроблемы = Ложь, "
			|<div id=""colorblock"">
			|<p><strong>Рекомендации</strong></p>
			|<p>Вместо использования механизма проактивных выплат СЭДО есть возможность отправить реестры прямых выплат, подробнее см. <a href=""https://its.1c.ru/db/staff1c#content:35033:hdoc"">справку</a>.</p>
