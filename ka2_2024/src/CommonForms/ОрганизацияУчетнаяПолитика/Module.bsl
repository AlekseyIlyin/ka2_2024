...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда") Тогда
		...
		МодульОхранаТрудаФормы.ДополнитьФормуУчетнойПолитикиОрганизации(ЭтотОбъект);
	КонецЕсли;
...
Процедура СохранитьДанныеНаСервере(Отказ)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда") Тогда
		МодульОхранаТрудаФормы = ОбщегоНазначения.ОбщийМодуль("ОхранаТрудаФормы");
		МодульОхранаТрудаФормы.ЗаписатьДополнительныеДанныеФормыУчетнойПолитикиОрганизации(ЭтотОбъект);
	КонецЕсли;
