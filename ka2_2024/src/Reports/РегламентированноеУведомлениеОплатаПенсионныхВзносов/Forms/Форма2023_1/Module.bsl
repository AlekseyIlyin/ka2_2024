...
Процедура ПредставлениеУведомленияПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	ИначеЕсли Область.Имя = "Фамилия" Или Область.Имя = "Имя" Или Область.Имя = "Отчество" Тогда
		ИмяСтраницыВДереве(ДеревоСтраниц, УИДТекущаяСтраница, ДанныеМногостраничныхРазделов);
	КонецЕсли;
КонецПроцедуры
...
Процедура ПредставлениеУведомленияВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Область.Имя = "ПроверитьВыгрузкуСправки" Тогда
		ТаблицаОшибок = ПроверитьВыгрузкуСправкиНаСервере();
	...
	ИначеЕсли Область.Имя = "ВыгрузитьСправку" Тогда
		ВыгружаемыеДанные = СформироватьСправкуXMLНаСервере(УникальныйИдентификатор);
	...
	ИначеЕсли Область.Имя = "ЗагрузитьИзФайла" Тогда
		УведомлениеОСпецрежимахНалогообложенияКлиент.ЗагрузитьИзФайлаСправку(ЭтотОбъект);
		СтандартнаяОбработка = Ложь;
		Возврат;
...
Процедура ИмяСтраницыВДереве(ДеревоСтраниц, УИДТекущаяСтраница, ДанныеМногостраничныхРазделов, Данные = Неопределено) Экспорт 
	...
	Если Данные = Неопределено Тогда 
		Для Каждого Стр Из ДанныеМногостраничныхРазделов.СведУплПенсВзн Цикл 
...
&НаСервере
Процедура ПереименованиеСтраниц()
	Для Каждого Стр Из ДанныеМногостраничныхРазделов.СведУплПенсВзн Цикл 
		ИмяСтраницыВДереве(ДеревоСтраниц, Стр.Значение.УИД, ДанныеМногостраничныхРазделов, Стр.Значение);
	КонецЦикла;
КонецПроцедуры
...
&НаСервере
Функция СформироватьСправкуXMLНаСервере(УникальныйИдентификатор)
	СохранитьДанные();
...
&НаСервере
Функция ПроверитьВыгрузкуСправкиНаСервере()
	СохранитьДанные();
