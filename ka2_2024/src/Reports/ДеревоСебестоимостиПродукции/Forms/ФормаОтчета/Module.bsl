...
Функция ПолучитьПараметрыОтчета(НастройкиКД)
	...
	СтруктураПараметров = Новый Структура("Период,ДетализироватьСтоимостьДоСоставляющих,ДанныеПоСебестоимости");
	...
	СтруктураПараметров.ДетализироватьСтоимостьДоСоставляющих = ПараметрДетализироватьСтоимостьДоСоставляющих.Значение;
	СтруктураПараметров.ДанныеПоСебестоимости = ПараметрДанныеПоСебестоимости.Значение;
	
	Если НЕ ПараметрПериод.Использование ИЛИ НЕ ЗначениеЗаполнено(ПараметрПериод.Значение) Тогда
		СтруктураПараметров.Период = Новый СтандартныйПериод();
	Иначе
		СтруктураПараметров.Период = ПараметрПериод.Значение;
	КонецЕсли;
