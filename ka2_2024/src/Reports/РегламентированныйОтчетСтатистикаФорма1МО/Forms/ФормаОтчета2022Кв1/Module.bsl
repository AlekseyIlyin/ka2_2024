...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "СправочникКодОКТМО",
	512, , "Выбор кода ОКТМО", КоллекцияСписковВыбора["КодОКТМО"]);
