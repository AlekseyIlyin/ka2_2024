...
Функция ПолучитьМассивКатегорий()
	...
	МногострочныеЧасти =
		...
		|П0040010001;П0040020001;П0040030001;П0050010001;П0060010001";
	...
	Для Каждого Стр Из КатегорииКлассификатора Цикл
		...
		ИначеЕсли Стр = "П0040010001" Тогда
			...
			Для Инд = 1 По 14 Цикл
				Если Инд < 5 Тогда
					ТипКолонки = Новый ОписаниеТипов("Строка");
				ИначеЕсли Инд = 5 Или Инд = 6 Тогда
					ТипКолонки = Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 1));
				ИначеЕсли Инд >= 7 И Инд <= 10 Тогда
					ТипКолонки = Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 2));
				ИначеЕсли Инд >= 11 И Инд <= 14 Тогда
					ТипКолонки = Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 0));
				КонецЕсли;
		...
		ИначеЕсли Стр = "П0060010001" Тогда
			...
			мСтруктураМногострочныхРазделов.Вставить(ИмяДобавляемогоРеквизита, ИмяДобавляемогоРеквизита);
			мСтруктураИсхКолвоСтрокРазделов.Вставить(ИмяДобавляемогоРеквизита, 1);
			мСтруктураКолвоКолонокРазделов.Вставить(ИмяДобавляемогоРеквизита, 6);
