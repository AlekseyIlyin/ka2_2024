...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Попытка
		Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.КвотыДляТрудоустройства") Тогда
			МодульКвотыДляТрудоустройства = ОбщегоНазначения.ОбщийМодуль("КвотыДляТрудоустройства");
			Если МодульКвотыДляТрудоустройства.ИспользуютсяКвотыДляТрудоустройства() Тогда
				...
				Для Каждого Поле Из СтрРазделить("П000010004004,П000010005004,П000010006004,П000010004005,П000010005005,П000010006005", ",") Цикл 
					ПолеТабличногоДокументаФормаОтчета.Область(Поле).ЦветФона = ЦФЖ;
...
Процедура Расчет(Форма)
	...
	Если Форма.ЕстьАвтозаполнение Тогда 
	...
	Иначе
		Области.П000010004003.Значение = Цел(Области.П000010001003.Значение / 25);
		Области.П000010004004.Значение = ОкруглитьВБольшуюСторону(Области.П000010001004.Значение / 50);
		Области.П000010004005.Значение = Области.П000010004003.Значение - Области.П000010004004.Значение;
		
		Области.П000010005003.Значение = Цел(Области.П000010002003.Значение / 25);
		Области.П000010005004.Значение = ОкруглитьВБольшуюСторону(Области.П000010002004.Значение / 50);
		Области.П000010005005.Значение = Области.П000010005003.Значение - Области.П000010005004.Значение;
		
		Области.П000010006003.Значение = Цел(Области.П000010003003.Значение / 25);
		Области.П000010006004.Значение = ОкруглитьВБольшуюСторону(Области.П000010003004.Значение / 50);
