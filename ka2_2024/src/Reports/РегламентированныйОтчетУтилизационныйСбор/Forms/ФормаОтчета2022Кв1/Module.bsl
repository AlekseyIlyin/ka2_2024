...
Функция ВыполнитьДокументированиеНаСервере()
	...
	СтруктураРезультата.Вставить("НаименованиеОтчета"	, "Расчет суммы утилизационного сбора в отношении колесных ТС");
	...
	Если НЕ СтруктураИсточник.Строки.Количество() = 0 Тогда
		Для каждого Приложение Из СтруктураИсточник.Строки Цикл
				...
				Для каждого СтраницаПриложения Из Приложение.Строки Цикл
					...
					НоваяСтрока.Р03С050 = ДанныеСтраницы.П000030005003;
...
Процедура ПолучитьКоэффициенты()
	...
	КоэффициентыДо3лет.Добавить(0.17);
	КоэффициентыДо3лет.Добавить(0.64);
	КоэффициентыДо3лет.Добавить(1.14);
	КоэффициентыДо3лет.Добавить(1.19);
	КоэффициентыДо3лет.Добавить(1.43);
	КоэффициентыДо3лет.Добавить(1.63);
	КоэффициентыДо3лет.Добавить(1.9);
	КоэффициентыДо3лет.Добавить(2);
	КоэффициентыДо3лет.Добавить(2.09);
	КоэффициентыДо3лет.Добавить(2.28);
	КоэффициентыДо3лет.Добавить(2.41);
	КоэффициентыДо3лет.Добавить(2.79);
	КоэффициентыДо3лет.Добавить(2.92);
	КоэффициентыДо3лет.Добавить(3.04);
	КоэффициентыДо3лет.Добавить(3.31);
	КоэффициентыДо3лет.Добавить(3.38);
	КоэффициентыДо3лет.Добавить(3.8);
	КоэффициентыДо3лет.Добавить(3.94);
	КоэффициентыДо3лет.Добавить(5.5);
	КоэффициентыДо3лет.Добавить(5.67);
	КоэффициентыДо3лет.Добавить(5.69);
	КоэффициентыДо3лет.Добавить(6.3);
	КоэффициентыДо3лет.Добавить(6.6);
	КоэффициентыДо3лет.Добавить(6.68);
	КоэффициентыДо3лет.Добавить(8.92);
	КоэффициентыДо3лет.Добавить(12.98);
	КоэффициентыДо3лет.Добавить(14.08);
	КоэффициентыДо3лет.Добавить(22.25);
	...
	КоэффициентыСвыше3лет.Добавить(0.26);
	КоэффициентыСвыше3лет.Добавить(1.15);
	КоэффициентыСвыше3лет.Добавить(1.26);
	КоэффициентыСвыше3лет.Добавить(1.45);
	КоэффициентыСвыше3лет.Добавить(2.88);
	КоэффициентыСвыше3лет.Добавить(3.04);
	КоэффициентыСвыше3лет.Добавить(3.12);
	КоэффициентыСвыше3лет.Добавить(3.45);
	КоэффициентыСвыше3лет.Добавить(5.06);
	КоэффициентыСвыше3лет.Добавить(5.24);
	КоэффициентыСвыше3лет.Добавить(5.98);
	КоэффициентыСвыше3лет.Добавить(6.1);
	КоэффициентыСвыше3лет.Добавить(6.15);
	КоэффициентыСвыше3лет.Добавить(7.95);
	КоэффициентыСвыше3лет.Добавить(8.05);
	КоэффициентыСвыше3лет.Добавить(10.39);
	КоэффициентыСвыше3лет.Добавить(11.5);
	КоэффициентыСвыше3лет.Добавить(11.57);
	КоэффициентыСвыше3лет.Добавить(13.57);
	КоэффициентыСвыше3лет.Добавить(14.95);
	КоэффициентыСвыше3лет.Добавить(15.69);
	КоэффициентыСвыше3лет.Добавить(23.13);
	КоэффициентыСвыше3лет.Добавить(24.01);
	КоэффициентыСвыше3лет.Добавить(28.5);
	КоэффициентыСвыше3лет.Добавить(35.01);
...
Процедура ПроверкаКС_1_01()
	...
	Заголовки.Вставить("Описание"			, "Значение КБК в стр.010 Раздела 1 должно соответствовать списку " +
		"допустимых значений");
	Заголовки.Вставить("Нарушение"			, "Ошибочное значение КБК");
	Заголовки.Вставить("Основание"			, "ст.80 НК РФ");
	Заголовки.Вставить("Рекомендации"		, "Выберите КБК из списка значений");
...
Процедура ПроверкаКС_1_02()
	...
	Заголовки.Вставить("Описание"			, "Общая сумма утилизационного сбора в стр.030 Раздела 1 = сумме " +
		"стр.170 Раздела 3");
	Заголовки.Вставить("Нарушение"			, "Ошибочная сумма утилизационного сбора");
	Заголовки.Вставить("Основание"			, "ст.80 НК РФ");
	...
	НастройкиКС.ЭтоОшибка = НЕ Показатели.Р01С030.Значение = Показатели.Р03С170.Итог;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р01С030.Значение, 
		Показатели.Р03С170.Итог);
	ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_2_01()
	...
	Заголовки.Вставить("НомерКС"			, "2.1");
	Заголовки.Вставить("Описание"			, "Дата составления расчета на Титульном листе >= стр.190 Раздела 3");
	Заголовки.Вставить("Нарушение"			, "Ошибочная дата выдачи паспорта ТС");
	Заголовки.Вставить("Основание"			, "ст.80 НК РФ");
...
Процедура ПроверкаКС_2_02()
	...
	Заголовки.Вставить("НомерКС"			, "2.2");
	...
	Заголовки.Вставить("Нарушение"			, "Ошибочное значение признака транспортного средства");
	Заголовки.Вставить("Основание"			, "ст.80 НК РФ");
	Заголовки.Вставить("Рекомендации"		, "Выберите признак транспортного средства из списка значений");
	Заголовки.Вставить("ШаблонДетализации"	, "недопустимое значение %1");
...
Процедура ПроверкаКС_2_03()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, "Раздел 3");
	Заголовки.Вставить("НомерКС"			, "2.3");
	Заголовки.Вставить("Описание"			, "Значение базовой ставки в стр.140 Раздела 3 = 0, 150.000, если признак " +
		"транспортного средства в стр.040 Раздела 3 = 11, 12, 20, 25, 26");
	Заголовки.Вставить("Нарушение"			, "Ошибочное значение базовой ставки");
	Заголовки.Вставить("Основание"			, "ст.80 НК РФ");
	Заголовки.Вставить("Рекомендации"		, "Уточните значение базовой ставки");
	Заголовки.Вставить("ШаблонДетализации"	, "%1 = 150000, если %2 = 11, 12, 20, 25, 26");
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 3");
	ПодготовитьНастройки(Заголовки);
	...
	МассивЗначений.Добавить("11");
	МассивЗначений.Добавить("12");
	...
	Для каждого СтраницаРаздела2 Из ДанныеКС.Раздел2 Цикл
		Для каждого СтраницаРаздела3 Из СтраницаРаздела2.Раздел21 Цикл
			...
			НастройкиКС.ЭтоОшибка = НЕ МассивЗначений.Найти(Показатели.Р03С040.Значение) = Неопределено
				И МассивСтавок.Найти(Показатели.Р03С140.Значение) = Неопределено;
			...
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р03С140.Значение, 
				Показатели.Р03С040.ЗначениеСтр);
			НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, СтраницаРаздела3.НомерСтраницы);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_2_04()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, "Раздел 3");
	Заголовки.Вставить("НомерКС"			, "2.4");
	Заголовки.Вставить("Описание"			, "Значение категории транспортного средства в стр.090 Раздела 3 должно " +
		"соответствовать списку допустимых значений");
	Заголовки.Вставить("Нарушение"			, "Ошибочное значение категории транспортного средства");
	Заголовки.Вставить("Основание"			, "ст.80 НК РФ");
	Заголовки.Вставить("Рекомендации"		, "Выберите категорию транспортного средства из списка значений");
	Заголовки.Вставить("ШаблонДетализации"	, "недопустимое значение %1");
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 3");
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_2_05()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, "Раздел 3");
	Заголовки.Вставить("НомерКС"			, "2.5");
	Заголовки.Вставить("Описание"			, "Категория транспортного средства в стр.090 Раздела 3 должна принимать " +
		"значение O4, если значение признака в стр.040 Раздела 3 = 25, 26");
	Заголовки.Вставить("Нарушение"			, "Ошибочное значение категории транспортного средства");
	Заголовки.Вставить("Основание"			, "ст.80 НК РФ");
	Заголовки.Вставить("Рекомендации"		, "Уточните значение категории транспортного средства");
	...
	Для каждого СтраницаРаздела2 Из ДанныеКС.Раздел2 Цикл
		Для каждого СтраницаРаздела3 Из СтраницаРаздела2.Раздел21 Цикл
			...
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р03С090.ЗначениеСтр, 
				Показатели.Р03С040.ЗначениеСтр);
			НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, СтраницаРаздела3.НомерСтраницы);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_2_06()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, "Раздел 3");
	Заголовки.Вставить("НомерКС"			, "2.6");
	Заголовки.Вставить("Описание"			, "Значение типа двигателя транспортного средства в стр.110 Раздела 3 должно " +
		"соответствовать списку допустимых значений");
	Заголовки.Вставить("Нарушение"			, "Ошибочное значение типа двигателя транспортного средства");
	Заголовки.Вставить("Основание"			, "ст.80 НК РФ");
	Заголовки.Вставить("Рекомендации"		, "Выберите тип двигателя транспортного средства из списка значений");
	Заголовки.Вставить("ШаблонДетализации"	, "недопустимое значение %1");
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 3");
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_2_07()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, "Раздел 3");
	Заголовки.Вставить("НомерКС"			, "2.7");
	Заголовки.Вставить("Описание"			, "Значение базовой ставки в стр.140 Раздела 3 = 0, 20.000, 150.000");
	Заголовки.Вставить("Нарушение"			, "Ошибочное значение базовой ставки");
	Заголовки.Вставить("Основание"			, "ст.80 НК РФ");
	Заголовки.Вставить("Рекомендации"		, "Уточните значение базовой ставки");
	Заголовки.Вставить("ШаблонДетализации"	, "недопустимое значение %1");
...
&НаСервере
Процедура ПроверкаКС_2_08_1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, "Раздел 3");
	Заголовки.Вставить("НомерКС"			, "2.8.1");
	Заголовки.Вставить("Описание"			, "Значение коэффициента в стр.150 Раздела 3 = " + ДанныеКС.КоэффициентыДо3ЛетСтр +
		", если с момента выпуска транспортного средства прошло не более 3 лет");
	Заголовки.Вставить("Нарушение"			, "Ошибочное значение коэффициента");
	Заголовки.Вставить("Основание"			, "ст.80 НК РФ");
	Заголовки.Вставить("Рекомендации"		, "Уточните значение коэффициента");
	Заголовки.Вставить("ШаблонДетализации"	, "недопустимое значение %1");
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 3");
	Заголовки.Вставить("ДляДокументации"	, "Отключено");
	...
	Для каждого СтраницаРаздела2 Из ДанныеКС.Раздел2 Цикл
		Для каждого СтраницаРаздела3 Из СтраницаРаздела2.Раздел21 Цикл
			...
			ЗаполнитьПоказатель(Показатели.Р03С150, СтраницаРаздела3);
			ЗаполнитьПоказатель(Показатели.Р03С080, СтраницаРаздела3);
			
			НастройкиКС.ЭтоОшибка = ЗначениеЗаполнено(Показатели.Р03С080.Значение)
				И ДобавитьМесяц(Показатели.Р03С080.Значение, 36) >= Показатели.Р00С001.Значение
				И ДанныеКС.КоэффициентыДо3Лет.Найти(Показатели.Р03С150.Значение) = Неопределено;
			...
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р03С150.Значение);
			НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, СтраницаРаздела3.НомерСтраницы);
			ДополнитьТаблицуРезультата();
...
&НаСервере
Процедура ПроверкаКС_2_08_2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, "Раздел 3");
	Заголовки.Вставить("НомерКС"			, "2.8.2");
	Заголовки.Вставить("Описание"			, "Значение коэффициента в стр.150 Раздела 3 = " + ДанныеКС.КоэффициентыСвыше3ЛетСтр +
		", если с момента выпуска транспортного средства прошло более 3 лет");
	Заголовки.Вставить("Нарушение"			, "Ошибочное значение коэффициента");
	Заголовки.Вставить("Основание"			, "ст.80 НК РФ");
	Заголовки.Вставить("Рекомендации"		, "Уточните значение коэффициента");
	Заголовки.Вставить("ШаблонДетализации"	, "недопустимое значение %1");
	...
	Для каждого СтраницаРаздела2 Из ДанныеКС.Раздел2 Цикл
		Для каждого СтраницаРаздела3 Из СтраницаРаздела2.Раздел21 Цикл
			...
			НастройкиКС.ЭтоОшибка = ЗначениеЗаполнено(Показатели.Р03С080.Значение)
				И ДобавитьМесяц(Показатели.Р03С080.Значение, 36) < Показатели.Р00С001.Значение
				И ДанныеКС.КоэффициентыСвыше3Лет.Найти(Показатели.Р03С150.Значение) = Неопределено;
...
Процедура ПроверкаКС_2_09()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, "Раздел 3");
	Заголовки.Вставить("НомерКС"			, "2.9");
	Заголовки.Вставить("Описание"			, "Сумма утилизационного сбора в стр.160 Раздела 3 = (стр.140 х стр.150) Раздела 3");
	Заголовки.Вставить("Нарушение"			, "Ошибочная сумма утилизационного сбора");
	Заголовки.Вставить("Основание"			, "ст.80 НК РФ");
	Заголовки.Вставить("Рекомендации"		, "Проверьте правильность расчета по формуле");
	...
	Для каждого СтраницаРаздела2 Из ДанныеКС.Раздел2 Цикл
		Для каждого СтраницаРаздела3 Из СтраницаРаздела2.Раздел21 Цикл
			...
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р03С160.Значение, РасчетнаяСумма, 
				Показатели.Р03С140.Значение, Показатели.Р03С150.Значение);
			НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, СтраницаРаздела3.НомерСтраницы);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_2_10()
	...
	Заголовки.Вставить("Описание"			, "Сумма утилизационного сбора в стр.170 Раздела 3 = (стр.160 - стр.130) Раздела 3");
	Заголовки.Вставить("Нарушение"			, "Ошибочная сумма утилизационного сбора");
	Заголовки.Вставить("Основание"			, "ст.80 НК РФ");
	Заголовки.Вставить("Рекомендации"		, "Проверьте правильность расчета по формуле");
	...
	Для каждого СтраницаРаздела2 Из ДанныеКС.Раздел2 Цикл
		Для каждого СтраницаРаздела3 Из СтраницаРаздела2.Раздел21 Цикл
			...
			ЗаполнитьПоказатели(Показатели, СтраницаРаздела3);
			РасчетнаяСумма = Показатели.Р03С160.Значение - Показатели.Р03С130.Значение;
			...
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р03С170.Значение, РасчетнаяСумма, 
				Показатели.Р03С160.Значение, Показатели.Р03С130.Значение);
			НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, СтраницаРаздела3.НомерСтраницы);
			ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_2_11()
	...
	Заголовки.Вставить("Описание"			, "Идентификационный номер транспортного средства (VIN) в стр.050 Раздела 3 " +
		"должен быть уникальным для каждой страницы Раздела 3");
	Заголовки.Вставить("Нарушение"			, "Неуникальное значение идентификационного номера транспортного средства (VIN)");
	Заголовки.Вставить("Основание"			, "ст.80 НК РФ");
	Заголовки.Вставить("Рекомендации"		, "Удалите дубли идентификационных номеров");
	...
	Пока ВыборкаГр.Следующий() Цикл
		...
		ЗаполнитьПоказатель(Показатели.Р03С050, ВыборкаГр);
		НастройкиКС.ЭтоОшибка = ЗначениеЗаполнено(Показатели.Р03С050.Значение) И ВыборкаГр.Колво > 1;
		...
		Пока Выборка.Следующий() Цикл
			...
			ЗаполнитьПоказатель(Показатели.Р03С050, Выборка);
			Показатели.Р03С050.Дополнение = НСтр("ru='Страница '") + Выборка.НомерСтраницы;
			РасшифроватьПоказатель(Показатели.Р03С050);
			МассивСтраниц.Добавить(Выборка.НомерСтраницы);
		
		КонецЦикла; 
		
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, Показатели.Р03С050.ЗначениеСтр);
		НастройкиКС.ДопСведения = СтрШаблон(НастройкиКС.ШаблонДопСведений, СтрСоединить(МассивСтраниц, ", "));
		ДополнитьТаблицуРезультата();
