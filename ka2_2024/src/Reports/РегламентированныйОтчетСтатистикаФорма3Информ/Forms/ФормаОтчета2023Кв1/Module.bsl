...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Для Гр = 3 По 4 Цикл
		...
		Для Стр = 205 По 208 Цикл
			СуммаПоСтр = СуммаПоСтр + Области["П0020010" + Стр + Графа].Значение;
		КонецЦикла;
		Области["П0020010201" + Графа].Значение = СуммаПоСтр;
	КонецЦикла;
	
	Области["П020001161203"].Значение
		= Области["П020001161303"].Значение
		+ Области["П020001161403"].Значение
		+ Области["П020001161503"].Значение
		+ Области["П020001161603"].Значение;
