...
Функция ТаблицаФормОтчета() Экспорт
	...
	// Редакция "ФормаОтчета2023Кв4" применяется начиная с отчета за период 4 квартал 2023 г.
	//
	...
	// С 01.01.2022 применяется только редакция "ФормаОтчета2021Кв4", включительно по отчет за период 3 квартал 2023 г.
	//
	НоваяФорма = ТаблицаФормОтчета.Добавить();
	...
	НоваяФорма.РедакцияФормы      = "от 27.09.2021 № 1618.";
