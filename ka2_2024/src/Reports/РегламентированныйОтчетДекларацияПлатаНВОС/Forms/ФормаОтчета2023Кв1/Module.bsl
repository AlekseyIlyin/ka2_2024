		...
		Для Каждого Стр2 Из ТаблицаСтраницыРаздела3_2 Цикл
			...
			Если ПервыйПроход Тогда
				...
				Если ЗначениеЗаполнено(ФиксированныеДанные.П000010000006) Тогда 
					УстановитьЗначениеЭлемента(НовУзел_onvos, "no_oro_export", "true");
					УстановитьЗначениеЭлемента(Узелoro, "name", 
					...
					УстановитьЗначениеЭлемента(УзелОКТМО, "oktmo", 
						ФиксированныеДанные.onvos_oktmo1);
				Иначе
					УстановитьЗначениеЭлемента(НовУзел_onvos, "no_oro_export", "false");
				...
				Если ЗначениеЗаполнено(ФиксированныеДанные.П000010000008) Тогда 
					УстановитьЗначениеЭлемента(Узелopo, "name", 
						ФиксированныеДанные.П000010000008);
					УстановитьЗначениеЭлемента(Узелopo, "number", 
						ФиксированныеДанные.П000010000009);
