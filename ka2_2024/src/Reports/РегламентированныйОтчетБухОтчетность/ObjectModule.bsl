...
Процедура ДобавитьПоказателиПояснений4_20210612(СохраненныеДанные)
	...
	НомерДопСтроки = 1;
	Пока Показатели.Свойство("П100100540001_" + СтрокаЧГ0(НомерДопСтроки)) Цикл
		Показатели.Вставить("П100100540021_" + СтрокаЧГ0(НомерДопСтроки), 0);
		Показатели.Вставить("П100100540022_" + СтрокаЧГ0(НомерДопСтроки), 0);
		Показатели.Вставить("П100100542021_" + СтрокаЧГ0(НомерДопСтроки), 0);
		Показатели.Вставить("П100100542022_" + СтрокаЧГ0(НомерДопСтроки), 0);
...
Процедура ДобавитьПоказателиПояснений2_20211209(СохраненныеДанные)
	...
	НомерДопСтроки = 1;
	Пока Показатели.Свойство("П100100520001_" + СтрокаЧГ0(НомерДопСтроки)) Цикл
		Показатели.Вставить("П100100520014_" + СтрокаЧГ0(НомерДопСтроки), 0);
		Показатели.Вставить("П100100521014_" + СтрокаЧГ0(НомерДопСтроки), 0);
		НомерДопСтроки = НомерДопСтроки + 1;
	КонецЦикла;
	
	НомерДопСтроки = 1;
	Пока Показатели.Свойство("П100100522001_" + СтрокаЧГ0(НомерДопСтроки)) Цикл
		Показатели.Вставить("П100100522014_" + СтрокаЧГ0(НомерДопСтроки), 0);
		Показатели.Вставить("П100100523014_" + СтрокаЧГ0(НомерДопСтроки), 0);
		НомерДопСтроки = НомерДопСтроки + 1;
	КонецЦикла;
