...
Функция ПолучитьВнешниеНаборыДанных(Организация, НаДату)
	...
	#Область ОтложенДоКонцаКвартала_11_и_Доступно_0
	// Отложен до конца квартала по учетной политике (11)
	Запрос.Текст = "ВЫБРАТЬ
					...
					|	- ОстаткиПоНДС11.Заблокировано11 КАК Заблокировано0
					|
