...
Процедура НастроитьПоОрганизации()
	...
	Если Не ИспользуетсяРаздельныйУчет Тогда
		...
		Если Отчет.ТекущаяСхемаКомпоновкиДанных = "СхемаКомпоновкиДанныхПоВариантамНалогообложения" Тогда
			КомпоновщикИнициализирован = Ложь;
		КонецЕсли;
	ИначеЕсли Отчет.ТекущаяСхемаКомпоновкиДанных = "СхемаКомпоновкиДанных" Тогда 
		КомпоновщикИнициализирован = Ложь;
	КонецЕсли;
