...
#Область ФильтрПоЭквайринговымТерминалам
	...
	Элементы.ГруппаФильтрПоЭквайринговымТерминалам.Видимость = Объект.ВариантНастройки <> "ОбменУПБП";
...
#Область ГруппаЭквайринговыйТерминалПоУмолчанию
	ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		"Видимость",
		(Объект.ВариантНастройки = "ОбменУПРМК" ИЛИ Объект.ВариантНастройки = "ОбменМК"  ИЛИ Объект.ВариантНастройки = "ОбменУПБП"));
#КонецОбласти
...
Процедура ОбновитьЗависимыеОтборы()
	...
	Если ЗначениеЗаполнено(КассаККМ) Тогда
		...
		ЗначенияРеквизитов = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(КассаККМ, "Владелец, Склад, Склад.РозничныйВидЦены");
