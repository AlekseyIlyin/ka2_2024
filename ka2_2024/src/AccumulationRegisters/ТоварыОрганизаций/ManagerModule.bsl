...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|Выполняется заполнение хозяйственной операции в движениях документа ""Ввод остатков товаров"".'");
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	СписокДокументов.Добавить("Документ.ВводОстатковТоваров");
	...
	Для каждого ПолноеИмяДокумента Из СписокДокументов Цикл
		...
		Если ПолноеИмяДокумента = "Документ.Сторно" Тогда
			Продолжить;
		КонецЕсли;
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Регистраторы.Добавить("Документ.ВводОстатковТоваров");
