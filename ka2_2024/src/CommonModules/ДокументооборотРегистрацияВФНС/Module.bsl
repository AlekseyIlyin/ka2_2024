...
Функция МетодыСервисаОбработкиЗаявления(ВерсияОбмена = 0)
	...
	Иначе
		...
		Результат.Вставить("АдресСервиса", 		"https://gosreg.1c.ru/gosreg");
	КонецЕсли;
...
Функция РежимТестирования()
	...
	Возврат ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить("РегистрацияЮЛ", "ТестовыйСервер", Ложь) = Истина;
