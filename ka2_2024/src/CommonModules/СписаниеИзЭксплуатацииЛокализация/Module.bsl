...
Процедура ОбработкаПроверкиЗаполнения(Объект, Отказ, ПроверяемыеРеквизиты) Экспорт
	...
	Если НЕ УчетнаяПолитика.СтоимостьТМЦВЭксплуатацииСписана(Объект.Организация, Объект.Дата) Тогда
...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, ИзмененныеРеквизиты) Экспорт
	...
	Если СтруктураИзмененныхРеквизитов.Свойство("Организация")
		...
		СтоимостьСписана = УчетнаяПолитика.СтоимостьТМЦВЭксплуатацииСписана(Объект.Организация, Объект.Дата);
