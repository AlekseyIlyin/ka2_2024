...
Функция СписатьСтоимостьТМЦВЭксплуатации(Организация, Период) Экспорт
	...
	|		&КонецГодаГраница, 
	|		Организация = ВЫРАЗИТЬ(&Организация КАК Справочник.Организации).ГоловнаяОрганизация) КАК УчетнаяПолитика
	|
	|ГДЕ
	|	УчетнаяПолитика.Период >= &НачалоГода
	|	И УчетнаяПолитика.СписатьСтоимостьТМЦВЭксплуатации";
		
	Запрос = Новый Запрос(ТекстЗапроса);
	Запрос.УстановитьПараметр("Организация", Организация);
	Запрос.УстановитьПараметр("НачалоГода", НачалоГода(Период));
	Запрос.УстановитьПараметр("КонецГодаГраница", Новый Граница(Период, ВидГраницы.Включая));
...
Функция СтоимостьТМЦВЭксплуатацииСписана(Организация, Период) Экспорт
	...
	|ГДЕ
	|	УчетнаяПолитика.СписатьСтоимостьТМЦВЭксплуатации
	|	И УчетнаяПолитика.Организация = ВЫРАЗИТЬ(&Организация КАК Справочник.Организации).ГоловнаяОрганизация
	|	И КОНЕЦПЕРИОДА(УчетнаяПолитика.Период, ГОД) < &Период";
