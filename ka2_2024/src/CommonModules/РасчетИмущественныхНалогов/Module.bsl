...
Функция ПолучитьРасчетПоЗемельномуНалогу(Организация, ПериодРасчета, ДополнительныеПараметры = Неопределено) Экспорт
	...
	РезультатРасчета = ВыполнитьРасчетЗемельногоНалога(ПараметрыРасчета, ДанныеДляРасчета, ДополнительныеПараметры);
...
Функция ПолучитьДанныеДляРасчетаНалогаНаИмуществоПоСреднейСтоимости(ПараметрыРасчета, ДополнительныеПараметры)
	...
	Пока Период <= НачалоМесяца(ПараметрыРасчета.мДатаКонцаПериодаОтчета) Цикл
		...
		|
		|	ЕСТЬNULL(СтавкиНалогаНаИмуществоПоОтдельнымОС.ОснованиеЛьготы.УстановленаРегиональнымЗаконом, ЛОЖЬ) КАК РегиональнаяЛьгота,
...
Функция ПолучитьДанныеДляРасчетаНалогаНаИмуществоПоКадастровойСтоимости(ПараметрыРасчета, ДополнительныеПараметры)
	...
	Для Сч = ПервыйМесяцРасчета По Месяц(ПараметрыРасчета.ПериодРасчета) Цикл
		...
		|
		|	ЕСТЬNULL(СтавкиНалогаНаИмуществоПоОтдельнымОсновнымСредствам.ОснованиеЛьготы.УстановленаРегиональнымЗаконом, ЛОЖЬ) КАК РегиональнаяЛьгота,
		...
		|
		|	ЕСТЬNULL(СтавкиНалогаНаИмуществоСрезПоследних.ОснованиеЛьготы.УстановленаРегиональнымЗаконом, ЛОЖЬ) КАК РегиональнаяЛьгота,
...
Функция ВыполнитьРасчетЗемельногоНалога(ПараметрыРасчета, ДанныеДляРасчета, ДополнительныеПараметры)
