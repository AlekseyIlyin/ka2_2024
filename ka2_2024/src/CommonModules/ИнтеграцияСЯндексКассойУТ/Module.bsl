...
Процедура ПредопределенныеШаблоныСообщений(Шаблоны) Экспорт
	...
	Шаблон.Вставить("Наименование", НСтр("ru = 'Счет на оплату через ЮKassa (Заказ клиента)'"));
	...
	Шаблон.Вставить("Наименование", НСтр("ru = 'Счет на оплату через ЮKassa (Счет на оплату клиенту)'"));
