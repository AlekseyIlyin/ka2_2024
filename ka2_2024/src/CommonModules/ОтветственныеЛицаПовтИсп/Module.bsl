...
Функция РеквизитыОтветственныхЛицДокумента(ИмяДокумента) Экспорт
	...
	Для Каждого Реквизит Из МетаданныеДокумента.Реквизиты Цикл
		...
		Если (МетаданныеДокумента = Метаданные.Документы.СверкаВзаиморасчетов
				Или МетаданныеДокумента = Метаданные.Документы.СверкаВзаиморасчетов2_5_11)
			И (Реквизит = Метаданные.Документы.СверкаВзаиморасчетов.Реквизиты.ГлавныйБухгалтерОрганизацииКонтрагента
				Или Реквизит = Метаданные.Документы.СверкаВзаиморасчетов.Реквизиты.РуководительОрганизацииКонтрагента
				Или Реквизит = Метаданные.Документы.СверкаВзаиморасчетов2_5_11.Реквизиты.ГлавныйБухгалтерОрганизацииКонтрагента
				Или Реквизит = Метаданные.Документы.СверкаВзаиморасчетов2_5_11.Реквизиты.РуководительОрганизацииКонтрагента) Тогда
			Продолжить;
		КонецЕсли;
