...
// Инициализирует структуру дополнительных параметров для выбора сертификата.
// 
Функция НовыеДополнительныеПараметрыКриптографии() Экспорт
	
	ДополнительныеПараметрыКриптографии = Новый Структура;
	ДополнительныеПараметрыКриптографии.Вставить("ПараметрыОтбора",                 Неопределено);
	ДополнительныеПараметрыКриптографии.Вставить("Заголовок",                       "");
	ДополнительныеПараметрыКриптографии.Вставить("ДобавитьМеткуДоверенногоВремени", Ложь);
	
	Возврат ДополнительныеПараметрыКриптографии;
...
Процедура ПараметрыКриптографии(Сервис,
	...
	// У формы могут быть установлены параметры Заголовок, НазваниеКнопки и ДобавитьМеткуДоверенногоВремени.
