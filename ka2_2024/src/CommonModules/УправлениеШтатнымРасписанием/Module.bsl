...
Функция СформироватьЗапросПоТекущемуСостояниюШтатногоРасписания(Регистратор, Организация, Дата, Подразделение = Неопределено) 
	...
	Если Результат.Пустой() Тогда
		...
		|ИЗ
		|	Справочник.ШтатноеРасписание КАК ШтатноеРасписание
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.НастройкиСтатистикиПерсонала КАК НастройкиСтатистикиПерсонала
		|		ПО НастройкиСтатистикиПерсонала.Организация = &Организация
		|			И НастройкиСтатистикиПерсонала.ИспользоватьОтчетностьМониторингаРаботниковСоциальнойСферы
		...
		|			И ВЫБОР
		|				КОГДА СтрокиОтчетностиМониторингаРаботниковСоциальнойСферы.ВидФормыМониторинга = ЗНАЧЕНИЕ(Перечисление.ВидыФормМониторингаРаботниковСоциальнойСферы.ЗПЗдрав)
		|					ТОГДА НастройкиСтатистикиПерсонала.ФормаЗПЗдрав
		|				КОГДА СтрокиОтчетностиМониторингаРаботниковСоциальнойСферы.ВидФормыМониторинга = ЗНАЧЕНИЕ(Перечисление.ВидыФормМониторингаРаботниковСоциальнойСферы.ЗПКультура)
		|					ТОГДА НастройкиСтатистикиПерсонала.ФормаЗПКультура
		|				КОГДА СтрокиОтчетностиМониторингаРаботниковСоциальнойСферы.ВидФормыМониторинга = ЗНАЧЕНИЕ(Перечисление.ВидыФормМониторингаРаботниковСоциальнойСферы.ЗПНаука)
		|					ТОГДА НастройкиСтатистикиПерсонала.ФормаЗПНаука
		|				КОГДА СтрокиОтчетностиМониторингаРаботниковСоциальнойСферы.ВидФормыМониторинга = ЗНАЧЕНИЕ(Перечисление.ВидыФормМониторингаРаботниковСоциальнойСферы.ЗПОбразование)
		|					ТОГДА НастройкиСтатистикиПерсонала.ФормаЗПОбразование
		|				КОГДА СтрокиОтчетностиМониторингаРаботниковСоциальнойСферы.ВидФормыМониторинга = ЗНАЧЕНИЕ(Перечисление.ВидыФормМониторингаРаботниковСоциальнойСферы.ЗПСоц)
		|					ТОГДА НастройкиСтатистикиПерсонала.ФормаЗПСоц
		|				КОГДА СтрокиОтчетностиМониторингаРаботниковСоциальнойСферы.ВидФормыМониторинга = ЗНАЧЕНИЕ(Перечисление.ВидыФормМониторингаРаботниковСоциальнойСферы.ЗПФизическаяКультураИСпорт)
...
Функция ЗапросПредставленияШтатноеРасписание(ТолькоРазрешенные, ДатаАктуальности, ИменаСведений = Неопределено, ИмяВТПредставления_ШтатноеРасписание = "Представления_ШтатноеРасписание", ВключатьНачисления = Истина, ИмяВТОтбораПозицийШтатногоРасписания = "") Экспорт
	...
	Если ВключатьНачисления Тогда
		...
		ТекстСводногоЗапроса = 
			...
			|ГДЕ
			|	ЕСТЬNULL(ПозицииШтатногоРасписания.КоличествоСтавок, 0) > 0
			|;
			|
			|////////////////////////////////////////////////////////////////////////////////
