...
Функция КоллекцияЦветовРаскраски() Экспорт
	...
	Результат.Вставить("ЦветЗаполняетсяТолькоВручную", Новый Цвет(255, 255, 225));
	Результат.Вставить("ЦветЗаполняетсяАвтоКорректир", Новый Цвет(255, 240, 200));
	Результат.Вставить("ЦветЗаполняетсяАвтоБезКорректир", Новый Цвет(230, 240, 220));
	Результат.Вставить("ЦветЗаполняетсяАвтоАрифметика", Новый Цвет(192, 220, 192));
	Результат.Вставить("ЦветЗаполняетсяОднозначноВручную", Новый Цвет(255, 255, 192));
	Результат.Вставить("ЦветЗаполняетсяАвтоматически", Новый Цвет(255, 255, 255));
	Результат.Вставить("ЦветАвто", Новый Цвет(0, 0, 0));
	Возврат	Результат;
