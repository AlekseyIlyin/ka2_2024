...
Функция ТекстЗапросаТаблицаВтТаблицаВНА(ТекстыЗапроса) Экспорт
	...
	ВнеоборотныеАктивыСлужебный.ТекстЗапросаТаблицаВтПорядокУчетаОСБУ(ТекстыЗапроса, "Документ.РеализацияУслугПрочихАктивов");
	ВнеоборотныеАктивыЛокализация.ТекстЗапросаТаблицаВтПараметрыЦелевогоФинансированияОС(ТекстыЗапроса, "Документ.РеализацияУслугПрочихАктивов");
	ВнеоборотныеАктивыЛокализация.ТекстЗапросаТаблицаВтПараметрыЦелевогоФинансированияНМА(ТекстыЗапроса, "Документ.РеализацияУслугПрочихАктивов");
	...
	|		ПО ТаблицаВНА.ВнеоборотныйАктив = ПорядокУчетаОСБУ.ОсновноеСредство
	|
...
Функция ТекстЗапросаТаблицаОтражениеДокументовВРеглУчете(Запрос, ТекстыЗапроса, Регистры)
	...
	ТекстЗапроса = РеглУчетПроведениеСервер.ТекстЗапросаОтраженияПоОбъектамРасчетов("Документ.РеализацияУслугПрочихАктивов.РасшифровкаПлатежа");
	МассивТекстовЗапроса.Добавить(ТекстЗапроса);
