...
Функция ИзмененВидРазницВУчетнойПолитике(Период, Организация, ПараметрыУчетнойПолитики, ПараметрыУчетнойПолитикиНУ)Экспорт
	...
	Если (ПараметрыУчетнойПолитики <> Неопределено
		...
		ПараметрыУчетнойПолитикиТекущегоПериода = НастройкиНалоговУчетныхПолитикПовтИсп.ДействующиеПараметрыНалоговУчетныхПолитик("УчетнаяПолитикаБухУчета",
			Организация,
			Период);
			
		ПараметрыУчетнойПолитикиПрошлогоПериода = НастройкиНалоговУчетныхПолитикПовтИсп.ДействующиеПараметрыНалоговУчетныхПолитик("УчетнаяПолитикаБухУчета",
			Организация,
...
Процедура ДополнитьПараметрыИнициализации(Запрос, Реквизиты) Экспорт
	...
	//++ Локализация
	ПараметрыУчетнойПолитикиУУ = НастройкиНалоговУчетныхПолитикПовтИсп.ДействующиеПараметрыНалоговУчетныхПолитик("УчетнаяПолитикаФинансовогоУчета",
		Реквизиты.Организация,
		Реквизиты.Период);
	ПараметрыУчетнойПолитикиБУ = НастройкиНалоговУчетныхПолитикПовтИсп.ДействующиеПараметрыНалоговУчетныхПолитик("УчетнаяПолитикаБухУчета",
		Реквизиты.Организация,
		Реквизиты.Период);
	ПараметрыУчетнойПолитикиНУ = НастройкиНалоговУчетныхПолитикПовтИсп.ДействующиеПараметрыНалоговУчетныхПолитик("НастройкиУчетаНалогаНаПрибыль",
		Реквизиты.Организация,
		Реквизиты.Период);
	//-- Локализация
...
Процедура ДополнитьДействующиеПараметрыУчетныхПолитик(ПараметрыУчетныхПолитик, Организация, Период) Экспорт
	...
	//++ Локализация
	ПараметрыУчетныхПолитик.УчетнаяПолитикаБухУчета = НастройкиНалоговУчетныхПолитик.ДействующиеПараметрыНалоговУчетныхПолитик(
		"УчетнаяПолитикаБухУчета",
		Организация,
		Период,
		Ложь);
	
	ПараметрыУчетныхПолитик.НастройкиУчетаНалогаНаПрибыль = НастройкиНалоговУчетныхПолитик.ДействующиеПараметрыНалоговУчетныхПолитик(
