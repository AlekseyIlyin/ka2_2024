...
Функция СведенияОРуководителяхОрганизаций(Организации) Экспорт
	...
	ПолучаемыеСведения = "РукСсылка,ДолжнРукСсылка";
	...
	Для каждого Организация Из Организации Цикл
		...
		СведенияОрганизации = РегламентированнаяОтчетностьВызовСервера.ПолучитьСведенияОбОрганизации(Организация, ДатаАктуальности, ПолучаемыеСведения);
		
		ДанныеРуководителя = Новый Структура("Руководитель,РуководительДолжность");

		Руководитель = Неопределено;
		СведенияОрганизации.Свойство("РукСсылка", Руководитель);
		ДанныеРуководителя.Руководитель = ?(Не ЗначениеЗаполнено(Руководитель), Справочники.ФизическиеЛица.ПустаяСсылка(), Руководитель);
		Должность = Неопределено;
		СведенияОрганизации.Свойство("ДолжнРукСсылка", Должность);
		ДанныеРуководителя.РуководительДолжность = ?(Не ЗначениеЗаполнено(Должность), Справочники.Должности.ПустаяСсылка(), Должность);
