...
//
// Параметры:
// 	Параметры - см. ШаблонПараметровПолученияФакта.
//
// Возвращаемое значение:
...
Процедура ПолучитьЗначенияПоИсточникуДанныхНефинансовый(ТаблицаДанныхПоВидуБюджета, ИсточникДанных, Параметры, ПараметрыДанных)
	...
	ПересчитатьТаблицуДанныхВВалюту(КопияТаблицаДанныхПоВидуБюджета, Параметры.ВалютаОтчета, Перечисления.ВидыУчетаВФункциональнойВалюте.ВВалютеРегл, ПоляПересчета);
...
//    ВалютаОтчета - СправочникСсылка.Валюта - Валюта, в которую требуется выполнить пересчет
...
//
Процедура ПересчитатьТаблицуДанныхВВалюту(ТаблицаДанных, ВалютаОтчета, ФункциональнаяВалюта, ПоляПересчета = Неопределено) Экспорт
...
Функция РассчитатьФактПоВидуБюджетаАльтернативный(ПараметрыДанных, Знач ИсточникиДанных, ВалютаОтчета, РежимПолученияДанных)
	...
	ПараметрыФактаОбороты = СтруктураПараметровФактаОбороты.ПараметрыФактаОбороты;
