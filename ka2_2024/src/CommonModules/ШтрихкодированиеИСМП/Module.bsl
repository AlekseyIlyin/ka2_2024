...
// * РазрешительныйРежимДатаЗапросаГИСМТ          - Дата, Неопределено                                                  - Дата получения идентификатора ГИС МТ
...
Функция ИнициализироватьСтруктуруДанныхИдентификатораГИСМТ() Экспорт
	...
	СтруктураВозврата.Вставить("РазрешительныйРежимДатаЗапросаГИСМТ",          Дата(1, 1, 1));
...
// * РазрешительныйРежимДатаЗапросаГИСМТ          - Дата - дата получения идентификатора ГИС МТ
Функция НовыйРезультатРаспределенияШтрихкодовПоТоварам()
	...
	ВозвращаемоеЗначение.Вставить("РазрешительныйРежимДатаЗапросаГИСМТ",          Дата(1,1,1));
