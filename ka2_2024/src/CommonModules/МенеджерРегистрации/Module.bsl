// Регистрация ERP Синхронизация данных через универсальный формат (2.5.11, v.1) от 04.06.2023 23:33:13
...
Функция ПараметрыРегистрации() Экспорт
	...
	Результат.Вставить("Наименование", НСтр("ru = 'ERP Синхронизация данных через универсальный формат (2.5.11, v.1)'"));
	Результат.Вставить("ДатаВремяСоздания", Дата(2023,6,4,23,33,0));
	...
	Результат.Вставить("ВерсияКонфигурации", "2.5.13.21");
...
Процедура ИнициализацияПравилРегистрации(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации) Экспорт
	...
	ДобавитьПРО_Документ_ВводОстатковВнеоборотныхАктивов2_4(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- НЕ УТ
	...
	ДобавитьПРО_Документ_ВводОстатковВнеоборотныхАктивов(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- НЕ УТ
	...
	ДобавитьПРО_Документ_ВыработкаСотрудников(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- НЕ УТ
	...
	ДобавитьПРО_Документ_СтатистикаПерсонала(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	...
	ДобавитьПРО_Документ_ВыбытиеДенежныхДокументов(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- НЕ УТ
	...
	ДобавитьПРО_Документ_ПоступлениеДенежныхДокументов(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- НЕ УТ
	...
	ДобавитьПРО_Документ_ВозвратСырьяОтПереработчика(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- Устарело_Переработка24
	
	//++ Устарело_Переработка24
	
	ДобавитьПРО_Документ_ОтчетПереработчика(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- Устарело_Переработка24
	...
	ДобавитьПРО_Документ_ПередачаСырьяПереработчику(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- Устарело_Переработка24
	...
	ДобавитьПРО_Документ_ПоступлениеОтПереработчика(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- Устарело_Переработка24
	...
	ДобавитьПРО_Документ_ОтчетПереработчика2_5(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- НЕ УТ
	...
	ДобавитьПРО_Документ_ВозвратМатериаловИзПроизводства(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	
	ДобавитьПРО_Документ_ВыпускПродукции(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- НЕ УТ
	...
	ДобавитьПРО_Документ_ДвижениеПродукцииИМатериалов(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- НЕ УТ
	...
	ДобавитьПРО_Документ_ПередачаМатериаловВПроизводство(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- НЕ УТ
	...
	ДобавитьПРО_Документ_ПроизводствоБезЗаказа(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- НЕ УТ
	...
	ДобавитьПРО_Документ_СписаниеИзЭксплуатации(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- НЕ УТ
	...
	ДобавитьПРО_Документ_ОтражениеЗарплатыВФинансовомУчете(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- НЕ УТ
	...
	ДобавитьПРО_РегистрСведений_ПорядокОтраженияНаСчетахУчета(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- НЕ УТ
	...
	ДобавитьПРО_Справочник_НематериальныеАктивы(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	
	ДобавитьПРО_Справочник_ОбъектыЭксплуатации(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- НЕ УТ
	...
	ДобавитьПРО_Справочник_ДенежныеДокументы(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- НЕ УТ
	...
	ДобавитьПРО_Справочник_ЦенныеБумаги(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- НЕ УТ
...
Процедура ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка) Экспорт
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВводОстатковВнеоборотныхАктивов2_4") Тогда 
		ПРО_Документ_ВводОстатковВнеоборотныхАктивов2_4_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВводОстатковВнеоборотныхАктивов") Тогда 
		ПРО_Документ_ВводОстатковВнеоборотныхАктивов_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("РегистрСведенийНаборЗаписей.ДокументыФизическихЛиц")
		 ИЛИ ТипЗнч(Объект) = Тип("РегистрСведенийЗапись.ДокументыФизическихЛиц")
		 ИЛИ ТипЗнч(Объект) = Тип("РегистрСведенийКлючЗаписи.ДокументыФизическихЛиц") Тогда 
		ПРО_РегистрСведений_ДокументыФизическихЛиц_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка);
	//++ Локализация
	
	//++ НЕ УТ
	
	ИначеЕсли ТипЗнч(Объект) = Тип("РегистрСведенийНаборЗаписей.ПорядокОтраженияНаСчетахУчета")
		 ИЛИ ТипЗнч(Объект) = Тип("РегистрСведенийЗапись.ПорядокОтраженияНаСчетахУчета")
		 ИЛИ ТипЗнч(Объект) = Тип("РегистрСведенийКлючЗаписи.ПорядокОтраженияНаСчетахУчета") Тогда 
		ПРО_РегистрСведений_ПорядокОтраженияНаСчетахУчета_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка);
	//-- НЕ УТ
	
	//-- Локализация
	
	ИначеЕсли ТипЗнч(Объект) = Тип("РегистрСведенийНаборЗаписей.СостоянияЗаказовКлиентов")
		 ИЛИ ТипЗнч(Объект) = Тип("РегистрСведенийЗапись.СостоянияЗаказовКлиентов")
		 ИЛИ ТипЗнч(Объект) = Тип("РегистрСведенийКлючЗаписи.СостоянияЗаказовКлиентов") Тогда 
		ПРО_РегистрСведений_СостоянияЗаказовКлиентов_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка);
	//++ Локализация
	
	ИначеЕсли ТипЗнч(Объект) = Тип("РегистрСведенийНаборЗаписей.СостоянияПоОбъектамУчетаЭДО")
		 ИЛИ ТипЗнч(Объект) = Тип("РегистрСведенийЗапись.СостоянияПоОбъектамУчетаЭДО")
		 ИЛИ ТипЗнч(Объект) = Тип("РегистрСведенийКлючЗаписи.СостоянияПоОбъектамУчетаЭДО") Тогда 
		ПРО_РегистрСведений_СостоянияПоОбъектамУчетаЭДО_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка);
	//-- Локализация
	
	ИначеЕсли ТипЗнч(Объект) = Тип("РегистрСведенийНаборЗаписей.ФИОФизическихЛиц")
		 ИЛИ ТипЗнч(Объект) = Тип("РегистрСведенийЗапись.ФИОФизическихЛиц")
		 ИЛИ ТипЗнч(Объект) = Тип("РегистрСведенийКлючЗаписи.ФИОФизическихЛиц") Тогда 
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("СправочникОбъект.НематериальныеАктивы") Тогда 
		ПРО_Справочник_НематериальныеАктивы_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("СправочникОбъект.ОбъектыЭксплуатации") Тогда 
		ПРО_Справочник_ОбъектыЭксплуатации_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка);
	//-- НЕ УТ
...
Процедура ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства) Экспорт
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВыработкаСотрудников") Тогда 
		ПРО_Документ_ВыработкаСотрудников_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.СтатистикаПерсонала") Тогда 
		ПРО_Документ_СтатистикаПерсонала_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.РезервыПоОплатеТруда") Тогда 
		ПРО_Документ_РезервыПоОплатеТруда_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВедомостьНаВыплатуЗарплатыВБанк") Тогда 
		ПРО_Документ_ВедомостьНаВыплатуЗарплатыВБанк_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВедомостьНаВыплатуЗарплатыВКассу") Тогда 
		ПРО_Документ_ВедомостьНаВыплатуЗарплатыВКассу_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВедомостьНаВыплатуЗарплатыПеречислением") Тогда 
		ПРО_Документ_ВедомостьНаВыплатуЗарплатыПеречислением_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВедомостьПрочихДоходовВБанк") Тогда 
		ПРО_Документ_ВедомостьПрочихДоходовВБанк_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВедомостьПрочихДоходовВКассу") Тогда 
		ПРО_Документ_ВедомостьПрочихДоходовВКассу_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВедомостьПрочихДоходовПеречислением") Тогда 
		ПРО_Документ_ВедомостьПрочихДоходовПеречислением_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВедомостьНаВыплатуЗарплатыРаздатчиком") Тогда 
		ПРО_Документ_ВедомостьНаВыплатуЗарплатыРаздатчиком_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ДепонированиеЗарплаты") Тогда 
		ПРО_Документ_ДепонированиеЗарплаты_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВыбытиеДенежныхДокументов") Тогда 
		ПРО_Документ_ВыбытиеДенежныхДокументов_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ПоступлениеДенежныхДокументов") Тогда 
		ПРО_Документ_ПоступлениеДенежныхДокументов_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВозвратСырьяОтПереработчика") Тогда 
		ПРО_Документ_ВозвратСырьяОтПереработчика_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	//-- Устарело_Переработка24
	
	//++ Устарело_Переработка24
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ОтчетПереработчика") Тогда 
		ПРО_Документ_ОтчетПереработчика_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	//-- Устарело_Переработка24
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ПередачаСырьяПереработчику") Тогда 
		ПРО_Документ_ПередачаСырьяПереработчику_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	//-- Устарело_Переработка24
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ПоступлениеОтПереработчика") Тогда 
		ПРО_Документ_ПоступлениеОтПереработчика_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	//-- Устарело_Переработка24
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ОтчетПереработчика2_5") Тогда 
		ПРО_Документ_ОтчетПереработчика2_5_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВозвратМатериаловИзПроизводства") Тогда 
		ПРО_Документ_ВозвратМатериаловИзПроизводства_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВыпускПродукции") Тогда 
		ПРО_Документ_ВыпускПродукции_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ДвижениеПродукцииИМатериалов") Тогда 
		ПРО_Документ_ДвижениеПродукцииИМатериалов_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ПередачаМатериаловВПроизводство") Тогда 
		ПРО_Документ_ПередачаМатериаловВПроизводство_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ПроизводствоБезЗаказа") Тогда 
		ПРО_Документ_ПроизводствоБезЗаказа_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.СписаниеИзЭксплуатации") Тогда 
		ПРО_Документ_СписаниеИзЭксплуатации_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.РегламентированныйОтчет") Тогда 
		ПРО_Документ_РегламентированныйОтчет_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("РегистрСведенийНаборЗаписей.ДоступностьТоваровДляВнешнихПользователей")
		 ИЛИ ТипЗнч(Объект) = Тип("РегистрСведенийЗапись.ДоступностьТоваровДляВнешнихПользователей")
		 ИЛИ ТипЗнч(Объект) = Тип("РегистрСведенийКлючЗаписи.ДоступностьТоваровДляВнешнихПользователей") Тогда 
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("РегистрСведенийНаборЗаписей.ШтрихкодыНоменклатуры")
		 ИЛИ ТипЗнч(Объект) = Тип("РегистрСведенийЗапись.ШтрихкодыНоменклатуры")
		 ИЛИ ТипЗнч(Объект) = Тип("РегистрСведенийКлючЗаписи.ШтрихкодыНоменклатуры") Тогда 
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("СправочникОбъект.ПодразделенияОрганизаций") Тогда 
		ПРО_Справочник_ПодразделенияОрганизаций_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	//-- НЕ УТ
...
Процедура ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства) Экспорт
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВыработкаСотрудников") Тогда 
		ПРО_Документ_ВыработкаСотрудников_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.СтатистикаПерсонала") Тогда 
		ПРО_Документ_СтатистикаПерсонала_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.РезервыПоОплатеТруда") Тогда 
		ПРО_Документ_РезервыПоОплатеТруда_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВедомостьНаВыплатуЗарплатыВБанк") Тогда 
		ПРО_Документ_ВедомостьНаВыплатуЗарплатыВБанк_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВедомостьНаВыплатуЗарплатыВКассу") Тогда 
		ПРО_Документ_ВедомостьНаВыплатуЗарплатыВКассу_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВедомостьНаВыплатуЗарплатыПеречислением") Тогда 
		ПРО_Документ_ВедомостьНаВыплатуЗарплатыПеречислением_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВедомостьПрочихДоходовВБанк") Тогда 
		ПРО_Документ_ВедомостьПрочихДоходовВБанк_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВедомостьПрочихДоходовВКассу") Тогда 
		ПРО_Документ_ВедомостьПрочихДоходовВКассу_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВедомостьПрочихДоходовПеречислением") Тогда 
		ПРО_Документ_ВедомостьПрочихДоходовПеречислением_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВедомостьНаВыплатуЗарплатыРаздатчиком") Тогда 
		ПРО_Документ_ВедомостьНаВыплатуЗарплатыРаздатчиком_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ДепонированиеЗарплаты") Тогда 
		ПРО_Документ_ДепонированиеЗарплаты_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВыбытиеДенежныхДокументов") Тогда 
		ПРО_Документ_ВыбытиеДенежныхДокументов_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ПоступлениеДенежныхДокументов") Тогда 
		ПРО_Документ_ПоступлениеДенежныхДокументов_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВозвратСырьяОтПереработчика") Тогда 
		ПРО_Документ_ВозвратСырьяОтПереработчика_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	//-- Устарело_Переработка24
	
	//++ Устарело_Переработка24
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ОтчетПереработчика") Тогда 
		ПРО_Документ_ОтчетПереработчика_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	//-- Устарело_Переработка24
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ПередачаСырьяПереработчику") Тогда 
		ПРО_Документ_ПередачаСырьяПереработчику_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	//-- Устарело_Переработка24
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ПоступлениеОтПереработчика") Тогда 
		ПРО_Документ_ПоступлениеОтПереработчика_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	//-- Устарело_Переработка24
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ОтчетПереработчика2_5") Тогда 
		ПРО_Документ_ОтчетПереработчика2_5_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВозвратМатериаловИзПроизводства") Тогда 
		ПРО_Документ_ВозвратМатериаловИзПроизводства_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВыпускПродукции") Тогда 
		ПРО_Документ_ВыпускПродукции_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ДвижениеПродукцииИМатериалов") Тогда 
		ПРО_Документ_ДвижениеПродукцииИМатериалов_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ПередачаМатериаловВПроизводство") Тогда 
		ПРО_Документ_ПередачаМатериаловВПроизводство_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ПроизводствоБезЗаказа") Тогда 
		ПРО_Документ_ПроизводствоБезЗаказа_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.СписаниеИзЭксплуатации") Тогда 
		ПРО_Документ_СписаниеИзЭксплуатации_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.РегламентированныйОтчет") Тогда 
		ПРО_Документ_РегламентированныйОтчет_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("СправочникОбъект.ПодразделенияОрганизаций") Тогда 
		ПРО_Справочник_ПодразделенияОрганизаций_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	//-- НЕ УТ
...
Процедура ПослеОбработки(ПРО, Отказ, Объект, ОбъектМетаданных, Получатели, Выгрузка) Экспорт
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ВыбытиеДенежныхДокументов") Тогда 
		ПРО_Документ_ВыбытиеДенежныхДокументов_ПослеОбработки(ПРО, Отказ, Объект, ОбъектМетаданных, Получатели, Выгрузка);
	//-- НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("ДокументОбъект.ПоступлениеДенежныхДокументов") Тогда 
		ПРО_Документ_ПоступлениеДенежныхДокументов_ПослеОбработки(ПРО, Отказ, Объект, ОбъектМетаданных, Получатели, Выгрузка);
	//-- НЕ УТ
...
#Область Документ_ВводОстатковВнеоборотныхАктивов2_4
Процедура ДобавитьПРО_Документ_ВводОстатковВнеоборотныхАктивов2_4(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.ВводОстатковВнеоборотныхАктивов2_4";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
...
Процедура ПРО_Документ_ВводОстатковВнеоборотныхАктивов2_4_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка)
...
#Область Документ_ВводОстатковВнеоборотныхАктивов
Процедура ДобавитьПРО_Документ_ВводОстатковВнеоборотныхАктивов(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.ВводОстатковВнеоборотныхАктивов";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Истина;
...
Процедура ПРО_Документ_ВводОстатковВнеоборотныхАктивов_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка)
...
Процедура ПРО_Документ_КорректировкаПриобретения_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
	...
	//++ Локализация
	Если Объект.ТипКорректировки = Перечисления.ТипыКорректировки.КорректировкаДоВводаОстатковТоваровИУслуг Тогда
		Отказ = Истина;
	КонецЕсли;
	//-- Локализация
	
	Если Объект.ДокументОснование = Неопределено ИЛИ ТипЗнч(Объект.ДокументОснование) = Тип("ДокументСсылка.ОтчетПереработчика2_5") Тогда
		Отказ = Истина;
	КонецЕсли;
	//-- НЕ УТ
КонецПроцедуры
...
#Область Документ_ВыработкаСотрудников
Процедура ДобавитьПРО_Документ_ВыработкаСотрудников(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.ВыработкаСотрудников";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Ложь;
	...
	УстановитьОтборы(НовоеПравило, 
		Документ_ВыработкаСотрудников_ОтборПоСвойствамПланаОбмена(),
		ОтборПоСвойствамОбъекта_1());
КонецПроцедуры

Функция Документ_ВыработкаСотрудников_ОтборПоСвойствамПланаОбмена()
...
Процедура ПРО_Документ_ВыработкаСотрудников_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	ПараметрыОбработкиПРО.Отказ               = Отказ;
	ПараметрыОбработкиПРО.Объект              = Объект;
	ПараметрыОбработкиПРО.РазделыУчетаСтрокой = "Зарплата";
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_ВыработкаСотрудников_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
#Область Документ_СтатистикаПерсонала
Процедура ДобавитьПРО_Документ_СтатистикаПерсонала(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.СтатистикаПерсонала";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Ложь;
	...
	УстановитьОтборы(НовоеПравило, 
		Документ_СтатистикаПерсонала_ОтборПоСвойствамПланаОбмена(),
		ОтборПоСвойствамОбъекта_1());
КонецПроцедуры

Функция Документ_СтатистикаПерсонала_ОтборПоСвойствамПланаОбмена()
	Возврат "<ОтборПоСвойствамПланаОбмена>
			|	<ЭлементОтбора>
			|		<ЭтоСтрокаКонстанты>false</ЭтоСтрокаКонстанты>
			|		<ТипСвойстваОбъекта>Дата</ТипСвойстваОбъекта>
...
Процедура ПРО_Документ_СтатистикаПерсонала_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_СтатистикаПерсонала_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
Процедура ПРО_Документ_РезервыПоОплатеТруда_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_РезервыПоОплатеТруда_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
Процедура ПРО_Документ_ВедомостьНаВыплатуЗарплатыВБанк_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_ВедомостьНаВыплатуЗарплатыВБанк_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
Процедура ПРО_Документ_ВедомостьНаВыплатуЗарплатыВКассу_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_ВедомостьНаВыплатуЗарплатыВКассу_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
Процедура ПРО_Документ_ВедомостьНаВыплатуЗарплатыПеречислением_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_ВедомостьНаВыплатуЗарплатыПеречислением_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
Процедура ПРО_Документ_ВедомостьПрочихДоходовВБанк_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_ВедомостьПрочихДоходовВБанк_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
Процедура ПРО_Документ_ВедомостьПрочихДоходовВКассу_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_ВедомостьПрочихДоходовВКассу_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
Процедура ПРО_Документ_ВедомостьПрочихДоходовПеречислением_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_ВедомостьПрочихДоходовПеречислением_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
Процедура ПРО_Документ_ВедомостьНаВыплатуЗарплатыРаздатчиком_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_ВедомостьНаВыплатуЗарплатыРаздатчиком_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
Процедура ПРО_Документ_ДепонированиеЗарплаты_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_ДепонированиеЗарплаты_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
#Область Документ_ВыбытиеДенежныхДокументов
Процедура ДобавитьПРО_Документ_ВыбытиеДенежныхДокументов(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.ВыбытиеДенежныхДокументов";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Ложь;
...
Процедура ПРО_Документ_ВыбытиеДенежныхДокументов_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_ВыбытиеДенежныхДокументов_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
	...
	Выгрузка         = ПараметрыОбработкиПРОПослеОбработки.Выгрузка;
КонецПроцедуры
Процедура ПРО_Документ_ВыбытиеДенежныхДокументов_ПослеОбработки(ПРО, Отказ, Объект, ОбъектМетаданных, Получатели, Выгрузка)
...
#Область Документ_ПоступлениеДенежныхДокументов
Процедура ДобавитьПРО_Документ_ПоступлениеДенежныхДокументов(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.ПоступлениеДенежныхДокументов";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Ложь;
...
Процедура ПРО_Документ_ПоступлениеДенежныхДокументов_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_ПоступлениеДенежныхДокументов_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
	...
	Выгрузка         = ПараметрыОбработкиПРОПослеОбработки.Выгрузка;
КонецПроцедуры
Процедура ПРО_Документ_ПоступлениеДенежныхДокументов_ПослеОбработки(ПРО, Отказ, Объект, ОбъектМетаданных, Получатели, Выгрузка)
...
#Область Документ_ВозвратСырьяОтПереработчика
Процедура ДобавитьПРО_Документ_ВозвратСырьяОтПереработчика(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.ВозвратСырьяОтПереработчика";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Ложь;
...
Процедура ПРО_Документ_ВозвратСырьяОтПереработчика_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
...
КонецПроцедуры
Процедура ПРО_Документ_ВозвратСырьяОтПереработчика_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
#Область Документ_ОтчетПереработчика
Процедура ДобавитьПРО_Документ_ОтчетПереработчика(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.ОтчетПереработчика";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Ложь;
	...
	УстановитьОтборы(НовоеПравило, 
		Документ_ОтчетПереработчика_ОтборПоСвойствамПланаОбмена(),
		ОтборПоСвойствамОбъекта_1());
КонецПроцедуры

Функция Документ_ОтчетПереработчика_ОтборПоСвойствамПланаОбмена()
	Возврат "<ОтборПоСвойствамПланаОбмена>
			|	<ЭлементОтбора>
			|		<ЭтоСтрокаКонстанты>false</ЭтоСтрокаКонстанты>
			|		<ТипСвойстваОбъекта>Дата</ТипСвойстваОбъекта>
...
Процедура ПРО_Документ_ОтчетПереработчика_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	"ПланОбменаОрганизации.Ссылка.ВариантНастройки <> ""ОбменУП2ЗУП3"" И ПланОбменаОрганизации.Ссылка.ВерсияФорматаОбмена <> ""1.0"" И ПланОбменаОрганизации.Ссылка.ВерсияФорматаОбмена <> ""1.0.beta""");
КонецПроцедуры
Процедура ПРО_Документ_ОтчетПереработчика_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
Процедура ДобавитьПРО_Документ_ПередачаСырьяПереработчику(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.ПередачаСырьяПереработчику";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Ложь;
	...
	УстановитьОтборы(НовоеПравило, 
		Документ_ПередачаСырьяПереработчику_ОтборПоСвойствамПланаОбмена(),
		ОтборПоСвойствамОбъекта_1());
КонецПроцедуры

Функция Документ_ПередачаСырьяПереработчику_ОтборПоСвойствамПланаОбмена()
	Возврат "<ОтборПоСвойствамПланаОбмена>
			|	<ЭлементОтбора>
			|		<ЭтоСтрокаКонстанты>false</ЭтоСтрокаКонстанты>
			|		<ТипСвойстваОбъекта>Дата</ТипСвойстваОбъекта>
...
Процедура ПРО_Документ_ПередачаСырьяПереработчику_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	"ПланОбменаОрганизации.Ссылка.ВариантНастройки <> ""ОбменУП2ЗУП3"" И ПланОбменаОрганизации.Ссылка.ВерсияФорматаОбмена <> ""1.0"" И ПланОбменаОрганизации.Ссылка.ВерсияФорматаОбмена <> ""1.0.beta""");
КонецПроцедуры
Процедура ПРО_Документ_ПередачаСырьяПереработчику_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
#Область Документ_ПоступлениеОтПереработчика
Процедура ДобавитьПРО_Документ_ПоступлениеОтПереработчика(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.ПоступлениеОтПереработчика";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Ложь;
...
Процедура ПРО_Документ_ПоступлениеОтПереработчика_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	"ПланОбменаОрганизации.Ссылка.ВариантНастройки <> ""ОбменУП2ЗУП3"" И ПланОбменаОрганизации.Ссылка.ВерсияФорматаОбмена <> ""1.0"" И ПланОбменаОрганизации.Ссылка.ВерсияФорматаОбмена <> ""1.0.beta""");
КонецПроцедуры
Процедура ПРО_Документ_ПоступлениеОтПереработчика_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
Процедура ПРО_Документ_ПередачаТоваровХранителю_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	ПараметрыОбработкиПРО.Отказ               = Отказ;
	ПараметрыОбработкиПРО.Объект              = Объект;
	ПараметрыОбработкиПРО.РазделыУчетаСтрокой = "Производство, Продажи";
...
#Область Документ_ОтчетПереработчика2_5
Процедура ДобавитьПРО_Документ_ОтчетПереработчика2_5(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.ОтчетПереработчика2_5";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Ложь;
	...
	УстановитьОтборы(НовоеПравило, 
		Документ_ОтчетПереработчика2_5_ОтборПоСвойствамПланаОбмена(),
		ОтборПоСвойствамОбъекта_1());
КонецПроцедуры

Функция Документ_ОтчетПереработчика2_5_ОтборПоСвойствамПланаОбмена()
	Возврат "<ОтборПоСвойствамПланаОбмена>
			|	<ЭлементОтбора>
			|		<ЭтоСтрокаКонстанты>false</ЭтоСтрокаКонстанты>
			|		<ТипСвойстваОбъекта>Дата</ТипСвойстваОбъекта>
...
Процедура ПРО_Документ_ОтчетПереработчика2_5_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_ОтчетПереработчика2_5_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
#Область Документ_ВозвратМатериаловИзПроизводства
Процедура ДобавитьПРО_Документ_ВозвратМатериаловИзПроизводства(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.ВозвратМатериаловИзПроизводства";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Ложь;
...
Процедура ПРО_Документ_ВозвратМатериаловИзПроизводства_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_ВозвратМатериаловИзПроизводства_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
#Область Документ_ВыпускПродукции
Процедура ДобавитьПРО_Документ_ВыпускПродукции(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.ВыпускПродукции";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Ложь;
...
Процедура ПРО_Документ_ВыпускПродукции_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_ВыпускПродукции_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
#Область Документ_ДвижениеПродукцииИМатериалов
Процедура ДобавитьПРО_Документ_ДвижениеПродукцииИМатериалов(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.ДвижениеПродукцииИМатериалов";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Ложь;
	...
	УстановитьОтборы(НовоеПравило, 
		ОтборПоСвойствамПланаОбмена_1(),
		Документ_ДвижениеПродукцииИМатериалов_ОтборПоСвойствамОбъекта());
КонецПроцедуры

Функция Документ_ДвижениеПродукцииИМатериалов_ОтборПоСвойствамОбъекта()
	Возврат "<ОтборПоСвойствамОбъекта>
			|	<ЭлементОтбора>
			|		<ТипСвойстваОбъекта>Булево</ТипСвойстваОбъекта>
			|		<ВидСравнения>Равно</ВидСравнения>
...
Процедура ПРО_Документ_ДвижениеПродукцииИМатериалов_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_ДвижениеПродукцииИМатериалов_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
#Область Документ_ПередачаМатериаловВПроизводство
Процедура ДобавитьПРО_Документ_ПередачаМатериаловВПроизводство(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
...
Функция Документ_ПередачаМатериаловВПроизводство_ОтборПоСвойствамПланаОбмена()
	Возврат "<ОтборПоСвойствамПланаОбмена>
			|	<ЭлементОтбора>
			|		<ЭтоСтрокаКонстанты>false</ЭтоСтрокаКонстанты>
			|		<ТипСвойстваОбъекта>Дата</ТипСвойстваОбъекта>
...
Процедура ПРО_Документ_ПередачаМатериаловВПроизводство_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_ПередачаМатериаловВПроизводство_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
#Область Документ_ПроизводствоБезЗаказа
Процедура ДобавитьПРО_Документ_ПроизводствоБезЗаказа(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.ПроизводствоБезЗаказа";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Ложь;
...
Процедура ПРО_Документ_ПроизводствоБезЗаказа_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_ПроизводствоБезЗаказа_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
#Область Документ_СписаниеИзЭксплуатации
Процедура ДобавитьПРО_Документ_СписаниеИзЭксплуатации(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.СписаниеИзЭксплуатации";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Ложь;
...
Процедура ПРО_Документ_СписаниеИзЭксплуатации_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	Объект           = ПараметрыОбработкиПРОПослеОбработки.Объект;
КонецПроцедуры
Процедура ПРО_Документ_СписаниеИзЭксплуатации_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
Процедура ПРО_Документ_РегламентированныйОтчет_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)

	ПараметрыЗапроса.Вставить("Организация", Объект.Организация);
КонецПроцедуры
Процедура ПРО_Документ_РегламентированныйОтчет_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
Процедура ДобавитьПРО_Документ_УведомлениеОПеремещенииПрослеживаемыхТоваров(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	...
	УстановитьОтборы(НовоеПравило, 
		Документ_УведомлениеОПеремещенииПрослеживаемыхТоваров_ОтборПоСвойствамПланаОбмена(),
		ОтборПоСвойствамОбъекта_1());
КонецПроцедуры

Функция Документ_УведомлениеОПеремещенииПрослеживаемыхТоваров_ОтборПоСвойствамПланаОбмена()
	Возврат "<ОтборПоСвойствамПланаОбмена>
			|	<ЭлементОтбора>
			|		<ЭтоСтрокаКонстанты>false</ЭтоСтрокаКонстанты>
			|		<ТипСвойстваОбъекта>Дата</ТипСвойстваОбъекта>
...
Процедура ДобавитьПРО_Документ_ОтражениеЗарплатыВФинансовомУчете(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.ОтражениеЗарплатыВФинансовомУчете";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Ложь;
	...
	УстановитьОтборы(НовоеПравило, 
		Документ_ОтражениеЗарплатыВФинансовомУчете_ОтборПоСвойствамПланаОбмена(),
		ОтборПоСвойствамОбъекта_1());
КонецПроцедуры

Функция Документ_ОтражениеЗарплатыВФинансовомУчете_ОтборПоСвойствамПланаОбмена()
	Возврат "<ОтборПоСвойствамПланаОбмена>
			|	<ЭлементОтбора>
			|		<ЭтоСтрокаКонстанты>false</ЭтоСтрокаКонстанты>
			|		<ТипСвойстваОбъекта>Дата</ТипСвойстваОбъекта>
...
#Область РегистрСведений_ПорядокОтраженияНаСчетахУчета
Процедура ДобавитьПРО_РегистрСведений_ПорядокОтраженияНаСчетахУчета(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "РегистрСведений.ПорядокОтраженияНаСчетахУчета";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиСправочников";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Истина;
...
Процедура ПРО_РегистрСведений_ПорядокОтраженияНаСчетахУчета_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка)

	Отказ = Истина;
	
	АналитикаУчета = Объект.Отбор.АналитикаУчета.Значение;
	Если Не Выгрузка И (ТипЗнч(АналитикаУчета) = Тип("СправочникСсылка.ГруппыФинансовогоУчетаНоменклатуры")
		Или ТипЗнч(АналитикаУчета) = Тип("СправочникСсылка.ГруппыФинансовогоУчетаРасчетов"))
		И ЗначениеЗаполнено(АналитикаУчета) Тогда 
		
		ВыполнитьПравилаРегистрацииДляОбъекта(АналитикаУчета.ПолучитьОбъект(), ПРО.ИмяПланаОбмена, Объект.ОбменДанными.Отправитель);	
	КонецЕсли;
КонецПроцедуры
...
#Область Справочник_НематериальныеАктивы
Процедура ДобавитьПРО_Справочник_НематериальныеАктивы(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Справочник.НематериальныеАктивы";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиСправочников";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Истина;
	...
	УстановитьОтборы(НовоеПравило, 
		...
		Справочник_НематериальныеАктивы_ОтборПоСвойствамОбъекта());
КонецПроцедуры

Функция Справочник_НематериальныеАктивы_ОтборПоСвойствамОбъекта()
	Возврат "<ОтборПоСвойствамОбъекта>
			|	<ЭлементОтбора>
			|		<ТипСвойстваОбъекта>Булево</ТипСвойстваОбъекта>
			|		<ВидСравнения>Равно</ВидСравнения>
			...
			|	</ЭлементОтбора>
			|	<ЭлементОтбора>
			|		<ТипСвойстваОбъекта>ПеречислениеСсылка.ВидыОбъектовУчетаНМА</ТипСвойстваОбъекта>
			|		<ВидСравнения>НеРавно</ВидСравнения>
			|		<СвойствоОбъекта>ВидОбъектаУчета</СвойствоОбъекта>
			|		<Вид>АлгоритмЗначения</Вид>
			|		<ЗначениеКонстанты>Значение = ПредопределенноеЗначение(""Перечисление.ВидыОбъектовУчетаНМА.РасходыНаНИОКР"")</ЗначениеКонстанты>
			|		<ТаблицаСвойствОбъекта>
			|			<Свойство>
			|				<Наименование>ВидОбъектаУчета</Наименование>
			|				<Тип>ПеречислениеСсылка.ВидыОбъектовУчетаНМА</Тип>
			|				<Вид>Реквизит</Вид>
			|			</Свойство>
			|		</ТаблицаСвойствОбъекта>
			|	</ЭлементОтбора>
...
Процедура ПРО_Справочник_НематериальныеАктивы_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка)
...
Процедура ДобавитьПРО_Справочник_ОбъектыЭксплуатации(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Справочник.ОбъектыЭксплуатации";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиСправочников";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Истина;
...
Процедура ПРО_Справочник_ОбъектыЭксплуатации_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка)
...
Процедура ДобавитьПРО_Справочник_Контрагенты2(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	...
	УстановитьОтборы(НовоеПравило, 
		ОтборПоСвойствамПланаОбмена_82(),
		ОтборПоСвойствамОбъекта_2());
КонецПроцедуры

Функция ОтборПоСвойствамПланаОбмена_82()
	Возврат "<ОтборПоСвойствамПланаОбмена>
			|	<ЭлементОтбора>
			|		<ЭтоСтрокаКонстанты>true</ЭтоСтрокаКонстанты>
			|		<ТипСвойстваОбъекта>Строка</ТипСвойстваОбъекта>
...
Процедура ДобавитьПРО_Справочник_СпособыОтраженияЗарплатыВБухУчете(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	...
	УстановитьОтборы(НовоеПравило, 
		Справочник_СпособыОтраженияЗарплатыВБухУчете_ОтборПоСвойствамПланаОбмена(),
		ОтборПоСвойствамОбъекта_2());
КонецПроцедуры

Функция Справочник_СпособыОтраженияЗарплатыВБухУчете_ОтборПоСвойствамПланаОбмена()
	Возврат "<ОтборПоСвойствамПланаОбмена>
			|	<ЭлементОтбора>
			|		<ЭтоСтрокаКонстанты>true</ЭтоСтрокаКонстанты>
			|		<ТипСвойстваОбъекта>Строка</ТипСвойстваОбъекта>
...
Процедура ДобавитьПРО_Справочник_ПодразделенияОрганизаций(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	...
	УстановитьОтборы(НовоеПравило, 
		Справочник_ПодразделенияОрганизаций_ОтборПоСвойствамПланаОбмена(),
		ОтборПоСвойствамОбъекта_2());
КонецПроцедуры

Функция Справочник_ПодразделенияОрганизаций_ОтборПоСвойствамПланаОбмена()
	Возврат "<ОтборПоСвойствамПланаОбмена>
			|	<ЭлементОтбора>
			|		<ЭтоСтрокаКонстанты>true</ЭтоСтрокаКонстанты>
			|		<ТипСвойстваОбъекта>Строка</ТипСвойстваОбъекта>
...
Процедура ПРО_Справочник_ПодразделенияОрганизаций_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)

	ПараметрыЗапроса.Вставить("Организация", Объект.Владелец);
КонецПроцедуры
Процедура ПРО_Справочник_ПодразделенияОрганизаций_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
...
#Область Справочник_ДенежныеДокументы
Процедура ДобавитьПРО_Справочник_ДенежныеДокументы(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Справочник.ДенежныеДокументы";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиСправочников";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Ложь;
...
#Область Справочник_ЦенныеБумаги
Процедура ДобавитьПРО_Справочник_ЦенныеБумаги(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации;
	
	НовоеПравило.ОбъектМетаданныхИмя = "Справочник.ЦенныеБумаги";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиСправочников";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь;
	НовоеПравило.ЕстьОбработчикПередОбработкой = Ложь;
