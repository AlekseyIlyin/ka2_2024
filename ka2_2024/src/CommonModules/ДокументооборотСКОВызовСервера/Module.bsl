...
Функция ТекущемуПользователюЭДОДоступен() Экспорт
	...
	Если НЕ ТекущемуПользователюАОДоступен Тогда
		...
		Если НЕ КонтекстЭДОСервер = Неопределено Тогда
			СписокДопустимыхОрганизацийВОбъектахОбменаФСС = КонтекстЭДОСервер.СписокДопустимыхОрганизацийВОбъектахОбменаФСС();
			Если СписокДопустимыхОрганизацийВОбъектахОбменаФСС.Количество() > 0 Тогда
				ТекущемуПользователюАОДоступен = Истина;
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
