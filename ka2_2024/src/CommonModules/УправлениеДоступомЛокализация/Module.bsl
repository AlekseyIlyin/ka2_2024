...
Процедура ДобавитьПрофилиЗарплатаИКадры(ОписанияПрофилей, ПараметрыОбновления, ДополнятьОбязательнымиРолями = Истина)
	...
	ОписаниеПапки = УправлениеДоступом.НовоеОписаниеПапкиПрофилейГруппДоступа();
	ОписаниеПапки.Имя           = "ЗарплатаИКадры";
	ОписаниеПапки.Идентификатор = "05de7c2f-eb81-11eb-81dc-4cedfb6825bf";
	ОписаниеПапки.Наименование  =
		НСтр("ru = 'Зарплата и кадры'",
			ОбщегоНазначения.КодОсновногоЯзыка());
	ОписанияПрофилей.Добавить(ОписаниеПапки);
	...
	Для НомерПрофиля = КоличествоПрофилейУТУП + 1 По ОписанияПрофилей.Количество() Цикл
		...
		Если ОписаниеПрофиля.Идентификатор = ЗарплатаКадрыРасширенный.ИдентификаторПрофиляСтаршийРасчетчик()
			...
			ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеОтносительныхКурсовВалют");
		...
		ОписаниеПрофиля.Родитель      = "ЗарплатаИКадры";
		...
		// Удаляем роли, которые вынесены в дополнительный профиль обмена ЭД
		УдаляемыеРоли = Новый Массив;
		УдаляемыеРоли.Добавить("ЧтениеНастроекЭлектронногоВзаимодействия");
		УдаляемыеРоли.Добавить("ЧтениеМаршрутовПодписания");
		УдаляемыеРоли.Добавить("ЧтениеНастроекОбменСБанками");
		УдаляемыеРоли.Добавить("ЧтениеОбменСБанками");
		УдаляемыеРоли.Добавить("ДобавлениеИзменениеМаршрутовПодписания");
		УдаляемыеРоли.Добавить("ДобавлениеИзменениеОбменСБанками");
		УдаляемыеРоли.Добавить("ВыполнениеОбменаОбменСБанками");
		Для Каждого Элемент Из УдаляемыеРоли Цикл
			ИндексРоли = ОписаниеПрофиля.Роли.Найти(Элемент);
			Если ИндексРоли <> Неопределено Тогда
				ОписаниеПрофиля.Роли.Удалить(ИндексРоли);
			КонецЕсли;
		КонецЦикла;
...
Процедура УстановитьРодителяПрофилейДоступаЗарплатаИКадры() Экспорт
	...
	ГруппаПрофилей      = Справочники.ПрофилиГруппДоступа.ПоставляемыйПрофильПоИдентификатору("ЗарплатаИКадры");
