...
Процедура КомандыЗаказНаЭмиссиюКодовМаркировкиСУЗ(Команды) Экспорт 
	...
	//++ Устарело_Переработка24
	ПодключаемыеКомандыИСКлиентСервер.ДобавитьКомандуВыбрать(
		Команды, "ЗаказПереработчику", НСтр("ru = 'Заказ переработчику'"), "ИспользуетсяТолькоПередачаВПереработку2_4");
	ПодключаемыеКомандыИСКлиентСервер.ДобавитьКомандуВыбрать(
		Команды, "ЗаказПереработчику", НСтр("ru = 'Заказ переработчику (2.4)'"), "ИспользуетсяПередачаВПереработку24и25");
	//-- Устарело_Переработка24
	ПодключаемыеКомандыИСКлиентСервер.ДобавитьКомандуВыбрать(
