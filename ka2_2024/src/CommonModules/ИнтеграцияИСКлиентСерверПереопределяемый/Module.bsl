...
Процедура ЗаполнитьСоответствиеПолейДокументовОснований(Форма, ТипОбъекта, СоответствиеПолей) Экспорт
	...
	Если ТипОбъекта = Тип("ДокументСсылка.ПогашениеСДИЗЗЕРНО") Тогда
		...
		МассивИменДокументов.Добавить("ДвижениеПродукцииИМатериалов");
		//++ Устарело_Переработка24
		МассивИменДокументов.Добавить("ПоступлениеОтПереработчика");
		МассивИменДокументов.Добавить("ВозвратСырьяОтПереработчика");
		МассивИменДокументов.Добавить("ПередачаСырьяПереработчику");
		//-- Устарело_Переработка24
