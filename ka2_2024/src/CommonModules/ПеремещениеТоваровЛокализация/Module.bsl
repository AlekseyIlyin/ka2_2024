...
Функция ТекстПеремещениеТоваровЗаБалансом()
	...
	ТекстЗапроса = "
	|ВЫБРАТЬ // Перемещение товаров за балансом (Дт 002, 003, 004 :: Кт 002, 003, 004)
	|	Строки.Ссылка КАК Ссылка,
	|	Строки.Период КАК Период,
	|	Строки.Организация КАК Организация,
	|	НЕОПРЕДЕЛЕНО КАК ИдентификаторСтроки,
...
Функция ТекстПередачаТоваровЗаБалансомСОбособленногоПодразделения()
	...
	ТекстЗапроса = "
	|ВЫБРАТЬ // Передача товаров забалансом с обособленного подразделения (Дт :: Кт 002, 003, 004)
	|
	|	Строки.Ссылка КАК Ссылка,
	|	Строки.Период КАК Период,
	|	Строки.Организация КАК Организация,
...
Функция ТекстПередачаТоваровЗаБалансомНаОбособленноеПодразделение()
	...
	ТекстЗапроса = "
	|ВЫБРАТЬ // Передача товаров забалансом на обособленное подразделение (Дт 002, 003, 004 :: Кт)
	|	Строки.Ссылка КАК Ссылка,
	|	Строки.Период КАК Период,
	|	Строки.Организация КАК Организация,
	|	НЕОПРЕДЕЛЕНО КАК ИдентификаторСтроки,
