...
//	ВариантыРаспределенияРасходов - Массив из ПеречислениеСсылка.ВариантыРаспределенияРасходов - 
Процедура ДополнитьДоступныеВариантыРаспределенияРасходов(ПараметрыВыбора, ВариантыРаспределенияРасходов) Экспорт
	...
	ПорядокУчетаНУ = ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(ПараметрыВыбора, "ПорядокУчетаНУ", Неопределено);
	
	Если ПорядокСписания.Найти(ПорядокУчетаНУ) <> Неопределено Тогда
		
		ОбщегоНазначенияКлиентСервер.ДополнитьМассив(
			ВариантыРаспределенияРасходов,
			ВнеоборотныеАктивыКлиентСервер.ДоступныеВариантыРаспределенияРасходовПриСписании());
...
Функция ЗначенияСвойствЗависимыхРеквизитов_ПерерасчетИмущественныхНалогов(Объект, ВспомогательныеРеквизиты, ИзмененныеРеквизиты = "") Экспорт
	...
	Если СтруктураИзмененныхРеквизитов.Свойство("ВариантПерерасчета")
		...
		//
		ЗначениеСвойства = 
			Объект.ВариантПерерасчета = ПредопределенноеЗначение("Перечисление.ВариантыПерерасчетаИмущественныхНалогов.Доначислить")
			ИЛИ Объект.ВариантПерерасчета = ПредопределенноеЗначение("Перечисление.ВариантыПерерасчетаИмущественныхНалогов.ПустаяСсылка");
