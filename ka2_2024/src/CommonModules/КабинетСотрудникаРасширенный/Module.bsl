...
Функция ЗагрузитьГрафикиОтпусков(ПараметрыОбмена, ПолученныеИзменения, РезультатОбработки, ВерсияИзменений) Экспорт
	...
	Для каждого СтрокаТЗ Из ТаблицаГрафиковОтпусков Цикл
		...
		Попытка
			...
			ДокументСборГрафиковОтпусков = ИдентификаторыДокументы[Объект.ИдентификаторДокумента];
			...
			СборГрафиковОтпусков.ОбработатьНовыйГрафикПодразделения(ОписаниеДокумента, ДокументСборГрафиковОтпусков);
