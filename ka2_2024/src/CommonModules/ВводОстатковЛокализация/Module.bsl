...
Функция ВводОстатковТоваровТекстОтраженияВРеглУчете() Экспорт
	...
	|			)
	|		ТОГДА НЕОПРЕДЕЛЕНО
	|		КОГДА Операция.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковМатериаловПереданныхПереработчикам2_5)
	...
	|ГДЕ
	|	(Операция.ОтражатьВБУиНУ ИЛИ Операция.ОтражатьВУУ)
	|	И НЕ Операция.ХозяйственнаяОперация В (
	|		ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковТоваровПолученныхНаКомиссию))";
