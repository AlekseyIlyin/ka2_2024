...
Процедура ПерепровестиДокументыПоРегистрам(ПараметрыРасчета)
	...
	Если НЕ ПараметрыРасчета.АвтоматическоеТестирование
	 ИЛИ ПараметрыРасчета.АвтоматическоеТестирование И НЕ ПараметрыРасчета.ИнформационнаяБазаФайловая
...
Процедура ИсправитьПроблемыВДвиженияхИДокументах(ПараметрыРасчета)
	...
	РасшифровкаКодовОшибок.Вставить(69, НСтр("ru='Не заполнен вид деятельности НДС при возврате от клиента по указанной стоимости'", ОбщегоНазначения.КодОсновногоЯзыка()));
