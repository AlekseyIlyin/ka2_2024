	...
	Пока НачалоПериода <= ПараметрыРасчета.КонецПериода Цикл
		...
		Попытка
			...
			ДанныеКРасчетуЗаМесяц = ЗакрытиеМесяцаСервер.ЗаданияКРасчетуЗаМесяц(НачалоПериода, ОкончаниеПериода,
				НомерЗаданияДоРасчета, ПараметрыРасчета.МассивОрганизаций, ПараметрыОбработчика.ДанныеЭтапа.Код);
...
Функция ПолучитьДействующиеПараметрыУчетныхПолитик(Организация, Период) Экспорт
	...
	ПараметрыУчетныхПолитик.УчетнаяПолитикаФинансовогоУчета = НастройкиНалоговУчетныхПолитик.ДействующиеПараметрыНалоговУчетныхПолитик(
