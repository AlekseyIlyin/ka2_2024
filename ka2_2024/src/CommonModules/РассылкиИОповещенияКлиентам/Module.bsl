...
// Добавить вложения печатные формы письмо по оповещению.
// 
// Параметры:
//  Письмо - ДокументОбъект.ЭлектронноеПисьмоИсходящее - Письмо
...
//     * Идентификатор - Строка - идентификатор команды печатной формы
//
Процедура ДобавитьВложенияПечатныеФормыПисьмоПоОповещению(Письмо, ПараметрыШаблона, СтрокаДанныхШаблона, ВыбранныеПечатныеФормы)
	...
	МетаданныеОбъект     = ИсточникОповещения.Метаданные(); //  ОбъектМетаданных
	...
	Для Каждого Вложение Из КомандыПечатиОбъекта Цикл
		Если НЕ Вложение.Отключена
			...
			ВложениеПечатнаяФорма = Новый Структура;
			ВложениеПечатнаяФорма.Вставить("ИмяКоманды",            Вложение.Идентификатор);
			ВложениеПечатнаяФорма.Вставить("ИдентификаторКоманды",  Вложение.УникальныйИдентификатор);
			ВложениеПечатнаяФорма.Вставить("Представление",         Вложение.Представление);
			ВложениеПечатнаяФорма.Вставить("МенеджерПечати",        Вложение.МенеджерПечати);
			ВложениеПечатнаяФорма.Вставить("ТипФайла",              "MXL");
			ВложениеПечатнаяФорма.Вставить("Статус",                "ПечатнаяФорма");
			ВложениеПечатнаяФорма.Вставить("ИмяПараметра",           "");
			ВложениеПечатнаяФорма.Вставить("ПараметрыПечати",        Вложение.ДополнительныеПараметры);
			
			ВложенияПечатныеФормы.Добавить(ВложениеПечатнаяФорма);
	...
	Для каждого ВложениеПечатнаяФорма Из ВложенияПечатныеФормы Цикл 
		...
		Если ВложениеПечатнаяФорма.Статус = "ПечатнаяФорма" Тогда
			...
			ИменаМакетов = ?(ПустаяСтрока(ВложениеПечатнаяФорма.ИмяКоманды), ВложениеПечатнаяФорма.ИдентификаторКоманды, ВложениеПечатнаяФорма.ИмяКоманды);
