...
Функция СписатьСтоимостьТМЦВЭксплуатации(Организация, Период) Экспорт
	...
	Возврат УчетнаяПолитикаПереопределяемый.СписатьСтоимостьТМЦВЭксплуатации(Организация, Период);
...
Функция СтоимостьТМЦВЭксплуатацииСписана(Организация, Период) Экспорт
	...
	Возврат УчетнаяПолитикаПереопределяемый.СтоимостьТМЦВЭксплуатацииСписана(Организация, ?(Период <> '000101010000', Период, ТекущаяДатаСеанса()));
