...
Процедура УстановитьДоступностьЭлементовДляСтатуса()
	...
	Элементы.ФормаПеренестиВАрхив.Доступность = Не СтатусВАрхиве И Не УчетнаяЗаписьДеактивирована И Не ПустаяСтрока(Запись.ИдентификаторОбъектаМаркетплейса);
	Элементы.ФормаУдалитьТовар.Доступность = ДоступноУдаление И Не УчетнаяЗаписьДеактивирована;
...
Процедура УстановитьДоступностьХарактеристикиУпаковки(ИзменениеНоменклатуры = Ложь)
	...
	РезультатПроверки =
			Справочники.Номенклатура.ХарактеристикаИУпаковкаПринадлежатВладельцу(Запись.Номенклатура, Запись.Характеристика, Запись.Упаковка);
