...
Процедура УстановитьСвойстваЭлементов(Форма)
	...
	ДоступностьРаздельногоУчетаПостатейныхЗатрат = 
		Форма.ПартионныйУчетВерсии22
	...
	Элементы.ГруппаРаздельныйУчетПостатейныхПроизводственныхЗатратКомментарий.Видимость =
		Запись.РаздельныйУчетТоваровПоНалогообложениюНДС
		И НЕ ДоступностьРаздельногоУчетаПостатейныхЗатрат;
	
	Элементы.УчетНДСДлительногоЦиклаПроизводства.Доступность = Запись.РаздельныйУчетПостатейныхПроизводственныхЗатратПоНалогообложениюНДС;
	//-- НЕ УТ
