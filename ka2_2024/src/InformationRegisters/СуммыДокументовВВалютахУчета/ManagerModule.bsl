...
Функция ТекстЗапросаСуммВзаиморасчетов(ИмяВТ = "")
	...
	|		ВЫБОР КОГДА ДанныеРегистровРасчетов.СуммаРасчетов <> 0 И ДанныеРегистровРасчетов.СуммаРасчетовУпр <> 0 И ДанныеРегистровРасчетов.СуммаРасчетовРегл <> 0
	|				ТОГДА (ДанныеРегистровРасчетов.СуммаРасчетовРегл / ДанныеРегистровРасчетов.СуммаРасчетов)
...
Процедура ПересчитатьТаблицуВВалютыУчета(МенеджерВременныхТаблиц)
	...
	|	ТаблицаТоваров.ДатаКурса,
	|	ТаблицаТоваров.Договор,
	|	ТаблицаТоваров.ВариантКурсаДоговора,
	|	ТаблицаТоваров.ВалютаВзаиморасчетов,
