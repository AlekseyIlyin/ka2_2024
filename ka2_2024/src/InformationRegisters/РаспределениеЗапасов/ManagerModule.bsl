...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|Исправляет остатки, связанные с неверными движениями исправительных документов и документа ""Сторно"",
	|а также с неверными движениями документов закупки по неотфактурованным поставкам работ'");
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Если РаспределениеЗапасов.ЭтоПроизводительныйРежим() Тогда
		...
		#Область ОшибкиДвиженийИсправительныхДокументов
			Запрос.Текст =
				"ВЫБРАТЬ РАЗЛИЧНЫЕ
				...
				|ПОМЕСТИТЬ РегистраторыСОшибками
				|ИЗ
				...
				|			Таблица.Регистратор КАК Регистратор
				|		ИЗ
				|			РегистраторыСОшибками КАК Таблица)";
