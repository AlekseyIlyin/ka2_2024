...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("22cbfe86-8bd2-4de9-8761-fae446ec1b1c");
	...
	Обработчик.Комментарий = НСтр("ru = 'В регистре сведений ""Нормативная длительность этапов производства"" заполняет ресурс ""Длительность до выпуска""'");
	...
	Изменяемые.Добавить(Метаданные.РегистрыСведений.НормативнаяДлительностьЭтаповПроизводства.ПолноеИмя());
	Обработчик.ИзменяемыеОбъекты = СтрСоединить(Изменяемые, ",");
	
	Блокируемые = Новый Массив;
	Блокируемые.Добавить(Метаданные.РегистрыСведений.НормативнаяДлительностьЭтаповПроизводства.ПолноеИмя());
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ПолноеИмяРегистра = "РегистрСведений.НормативнаяДлительностьЭтаповПроизводства";
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Для каждого Выборка Из ОбновляемыеДанные Цикл
		...
		РезультатРасчета = РассчитатьПоСпецификации(Выборка.Спецификация);
