...
Функция ТребуетсяРасчет(СписокОрганизаций, Период) Экспорт
	...
	Если ВнеоборотныеАктивы.АмортизацияНМАМожетНачислятьсяСДатыПринятияКУчету(СписокОрганизаций, Период) Тогда
...
//  ВыполненныеЗадания - см. РегистрыСведений.ЗаданияКРасчетуАмортизацииНМА.ЗаданияКРасчетуЗаМесяц
//
...
Функция ЗаданияНаСледующийПериод(СписокОрганизаций, НачалоПериода)
	...
	|
	|	ГДЕ
	|		АмортизацияНМА.Дата МЕЖДУ &НачалоМесяца И &КонецМесяца
	...
	Для Каждого ДанныеЗадания Из ЗаданияНаСледующийПериод Цикл
		...
		Если ВнеоборотныеАктивы.АмортизацияНМАМожетНачислятьсяСДатыПринятияКУчету(ДанныеЗадания.Организация, ДанныеЗадания.Период) Тогда
