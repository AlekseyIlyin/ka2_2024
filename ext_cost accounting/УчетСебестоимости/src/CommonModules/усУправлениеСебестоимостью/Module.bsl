...
Процедура УстановитьГраницуПоследовательности(Регистратор)
	
	ГраницаПоследовательностиНарушена = ГраницаПоследовательностиНарушена(Регистратор);
	
	Если Не ГраницаПоследовательностиНарушена Или 
			(ГраницаПоследовательностиНарушена И Не ГраницаПоследовательностиРаньшеЭтогоРегистратора(Регистратор)) Тогда
...
Функция ГраницаПоследовательностиРаньшеЭтогоРегистратора(Регистратор)
	Результат = усУправлениеПоследовательностью.ГраницаПоследовательностиРаньшеЭтогоДокумента(Регистратор);
	Возврат Результат;
КонецФункции

Функция ГраницаПоследовательностиНарушена(Регистратор)
	Возврат усУправлениеПоследовательностью.ЕстьДокументыПослеЭтого(Регистратор);
КонецФункции
