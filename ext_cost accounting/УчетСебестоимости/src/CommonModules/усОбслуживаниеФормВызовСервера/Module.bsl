...
Процедура ус_ОбновитьСебестоимостьМаржу(Форма) Экспорт
	ОбъектФормы = Форма.Объект;
	СписокНоменклатуры = ОбъектФормы.Товары.Выгрузить().ВыгрузитьКолонку("Номенклатура");

	ВыборкаПартийПоНоменклатуре = усОбслуживаниеФормВызовСервера.ОстаткиПартийПоНоменклатуре(ОбъектФормы.Ссылка, ОбъектФормы.Дата, ОбъектФормы.Склад, СписокНоменклатуры);
